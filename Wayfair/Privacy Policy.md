...
**HOW TO ENTER:**  To enter the Promotion, follow Wayfair on Instagram and upload an image that represents your perfect wedding with the hashtag #WayfairWedding during the Promotion Period in accordance with the judging criteria outlined below. There is no limit on the number of photo entries an entrant may submit during the Promotion Period.
