...
100 Huntington Avenue 4 Copley Place, Suite 7000  
Boston, MA 02116
...
You may terminate your account by sending a letter stating your intention to Wayfair LLC, 100 Huntington Avenue 4 Copley Place, Suite 7000, Boston, MA 02116 Att:Service or an email to service@wayfair.com, with the subject line "Termination Request".
...
Rewards Rewards Dollars Earned 3% of Net Amount Shipping Fees for Qualifying Purchases: • Free for orders over $49  
• $4.99 Flat Rate for orders $49 and under Redemption Period Three months from date on which Rewards-Eligible Purchase is made Membership Fee None
...
**WINNER'S LIST:** Entrants are responsible for complying with these Official Rules. To receive the winner's list for a specific Promotion, send a self-addressed stamped envelope to: Wayfair.com Giveaway Winner List Request, c/o Wayfair LLC, 100 Huntington Avenue 4 Copley Place, Suite 7000, Boston, MA 02116. Please reference the dates of the Promotion Period and Prize with your request.

**SPONSOR:** Wayfair LLC LLC, 100 Huntington Avenue 4 Copley Place, Suite 7000, Boston, MA 02116
...
Please allow the full processing time required to ship from the warehouse (specified on each product page), plus 3 business days in transit for delivery.
...
Deliveries to Canada will be completed by Purolator once the shipment has cleared customs. All Canadian import duties and taxes are calculated at checkout, so you won't have to worry about paying upon delivery. We offer the following ship method for Small Parcel shipments to Canada\*:

Ground

Please allow the full processing time required to ship from the warehouse (specified on each product page), plus 5-10 business days in transit for delivery.

For more information on Canadian shipments, click here.

\*Please note that expedited shipping is unavailable for Canadian shipments. All Small Parcel Canadian shipments are required to process through three-legs: shipping from the warehouse to the border via UPS/FedEx, processing through customs, and then changing hands to Purolator for final delivery.
...
Within the 'Refine' box on the left hand side of many of our browse pages, there is a 'Ships To' section that allows you to filter to only show items that can be shipped to Canada:
...
Large Parcel Curbside Deliveries: 5 - 10 Business Days  
Large Parcel Inside Deliveries: 4 - 6 Weeks  
...
Unless otherwise noted, we accept returns on all orders that ship to Canada. All orders fall under our Standard Return Policy. Please note: duties and GST will be refunded. However, all actual shipping costs and brokerage fees are non-refundable.
