...
**NO PURCHASE NECESSARY TO ENTER OR WIN. A PURCHASE DOES NOT INCREASE YOUR CHANCES OF WINNING. VOID WHERE PROHIBITED. The Wayfair Registry Sweepstakes ("Promotion") begins at 12:00:00 AM Eastern Time on Monday, January 23rd, 2017 and ends at 11:59:59 PM Eastern Time on Tuesday, February 28th, 2017.** _The computer clock of the Sponsor is the official time-keeping device in the Promotion._

**EACH ENTRANT HEREBY REPRESENTS AND WARRANTS THAT SUCH ENTRANT IS AT LEAST 18 YEARS OF AGE AND THAT SUCH ENTRANT HAS READ THESE OFFICIAL RULES AND IS FAMILIAR WITH AND AGREES TO ITS CONTENTS. IF ENTRANT IS NOT AT LEAST 18 YEARS OF AGE AND DOES NOT AGREE TO THESE OFFICIAL RULES, DO NOT PARTICIPATE IN THIS PROMOTION.**

**ELIGIBILITY:** The Promotion is open only to legal residents of the 50 United States and the District of Columbia (excludes Guam, Puerto Rico and all other U.S. territories and possessions), who are of the legal age of marriage at the time of Promotion registration (18 years or older in most locations, 19 in Nebraska, and 21 in Mississippi). The winner’s wedding must occur during the Promotion Period or within a year of the Promotion Period (wedding must fall between January 23rd, 2017 – February 28th, 2018). Employees, officers and directors of Wayfair LLC (the "Sponsor"), and Sponsor's parent, affiliates, subsidiaries, and advertising, contest, fulfillment and marketing agencies (all of such entities (including, but not limited to, the Sponsor) are collectively referred to herein as the, "Promotion Parties"), their immediate families (parent, child, sibling &. spouse and their respective spouses, regardless of where they reside) and persons living in the same households as such individuals (whether related or not) are not eligible to participate in the Promotion. By participating, you agree to these Official Rules and to the decisions of the Sponsor, which are final and binding in all respects. Void where prohibited by law, rule or regulation. All applicable federal, state and local laws and regulations apply.

**HOW TO ENTER THE SWEEPSTAKES:** To enter the Promotion, you must create a registry with Wayfair at www.wayfair.com/registry (the “Web Site”) and enter the sweepstakes at www.wayfair.com/registry/broadwaygetaway.To be eligible, a registry must contain at least one Lenox Dinnerware product during the Promotion Period. Registries without any Lenox Dinnerware products will not be eligible for submission in the drawing of the grand prize.

**Limit of one (1) entry per person, one (1) entry per couple, during the Promotion Period.**

**PRIZES, DRAWINGS &. ODDS OF WINNING:** A total of one (1) grand prize (the "Prize") will be selected in an electronic, randomized drawing. The drawing for the Prize (described below) will be held on March 1st, 2017. The drawing will be from all eligible entries received throughout the Promotion Period. The drawing will be conducted by the Sponsor, whose decisions are final and binding in all matters relating to this Promotion. Odds of winning depend on the number of eligible entries received.
...
*   Airfare for 2 to NYC (Approximate Retail Value “ARV”: up to $1,000 USD)
*   Hotel accommodations for 2 for 3 nights in NYC (ARV: up to $1,500 USD)
*   Hamilton tickets for 2 (or tickets to Broadway show of winner’s choice for 2) (ARV: up to $1,500)
*   Dinner for 2 for 2 nights in NYC (ARV: up to $500)
*   CPrivate visit to the Lenox showroom in NYC and work with Lenox Bridal Director to build your registry, lunch included (ARV: $500)
*   Lenox dinnerware package: china, flatware &. stemware service for twelve in pattern of choice (ARV: up to $4,000)
*   Wayfair gift card (ARV: $1,000)
*   Wayfair gift basket (ARV: up to $500)

**The Value of the Prize will be up to, but will not exceed, $10,500.00.**
