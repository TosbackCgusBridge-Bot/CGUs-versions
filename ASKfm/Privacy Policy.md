...
(2) All of your activity on the Ask.com website, the Toolbar and Ask mobile application (your queries, questions, answers, comments, search results selected, clicks, pages viewed, etc.)
...
(4) To distinguish your toolbar for purposes of compensating third parties who distributed the toolbar on our behalf and to analyze retention and usage per distribution partner or channel  
...
(2) If you use our service through an Toolbar, the information collected is stored in a query log for up to six months.  
...
(2) If you have installed a Toolbar, then our toolbar partners may collect/receive information about you including the queries you submit via the Services, the Toolbar functionality and/or website, the version of your Toolbar or your browser settings, the search results and ads you click on and the address of the web pages you previously visited.  
...
(1) You can turn on Ask Eraser and we will not store your search activity on Ask.com while Ask Eraser is turned on. AskEraser cannot be turned on from a mobile device and is not available for searches via toolbars.  
