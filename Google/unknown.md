...
_"Customer Data"_ or "Google Analytics Data" means the data you collect, process or store using the Service concerning the characteristics and activities of Visitors.
