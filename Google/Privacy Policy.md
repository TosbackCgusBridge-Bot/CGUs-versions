...
*   Visitar seu Histórico da Conta do Google para definir as configurações que permitem controlar o conjunto de informações pessoais nos serviços do Google, como a Pesquisa Google, YouTube e Histórico de Localização.
...
Podemos compartilharinformações que não sejam pessoalmente identificáveis agregadas, publicamente e com nossos parceiros – como sites de editores, anunciantes ou sites relacionados. Por exemplo, podemos compartilhar informações publicamente para mostrar tendências sobre o uso geral de nossos serviços.
...
Exemplo "como remover seu conteúdo"
