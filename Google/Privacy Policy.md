...
Exemple "supprimer vos contenus"

Par exemple, vous pouvez supprimer votre historique Web, votre blog, un site Google dont vous êtes propriétaire, votre chaîne YouTube, votre profil Google+ ou votre compte Google dans son intégralité.

Exemple "des informations relatives aux tendances"

Vous pouvez consulter des exemples dans Google Tendances des recherches et YouTube Trends.