'Your browser does not support JavaScript.Please enable the Javascript' Bing Privacy Statement
...
You may also contact Microsoft by using the web form. We will respond to requests to access or delete your personal information within 30 days.
...
Facebook currently powers the enhanced people search feature, so if you submit a search query while signed into Facebook that Bing classifies as a person’s name, we send the query to Facebook, which Facebook uses to return the relevant results.

Facebook does not use this query information for any other purpose, and deletes it within 24 hours.
...
For security purposes, all synced settings are transmitted using SSL. Some of these settings will not be synced on your PC and devices until you add your PC to your Microsoft account as a trusted PC.

If you do not want the service to store your customized settings on Microsoft servers or to download and apply them onto PCs and devices that you use, either do not sign into Windows with a Microsoft account or a domain account connected to a Microsoft account or turn off this functionality in the “sync your settings” options of Windows 8. Certain applications may store your search history on your PC and devices, and you may clear your search history by going to the “Settings” of that application.
...
If you have questions regarding one of our privacy statements, you should first contact us by using our Web form. If we do not acknowledge or satisfactorily address your inquiry, you should contact TRUSTe at http://www.truste.org/consumers/watchdog\_complaint.php.  TRUSTe will serve as a liaison with Microsoft to resolve your concerns.
