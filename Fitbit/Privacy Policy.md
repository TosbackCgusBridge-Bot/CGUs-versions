...
Once your Zip has synced, your information can be viewed online at Fitbit.com or through the free Fitbit iPhone and Android apps.
...
*   Wearing tips
*   Device Interface
*   Only in fitbit ultra
*   Sleep and activity logging

Wearing tip Everyone

Your Tracker works well on a waistband, a belt, or in a pocket. For thicker belts, you can put the device in the provided belt clip.

Women

Many women prefer to wear the Tracker on the center of their bra.

Device Display

Press the Tracker's button to see your progress for the current day.

Press once to see **steps**, again to see **distance**, then **calories burned**, and lastly a **flower icon** which shows how active you are throughout the day. Keep moving to keep the flower growing.
...
Fitbit Ultra owners have additional displays – **floors** climbed (1 Floor = 10 feet or 3 meters) and **clock**.

When you pick up the Tracker, it will greet you with **your name** and motivational **chatter**. You can customize the Tracker display in your user profile.
...
To start recording your sleep, or another activity, hold the button down until you either see **Start** (Classic) or the **Stopwatch** (Ultra) on the device display. When you're done sleeping (or your activity is complete) hold down the button again until you see **Stop**.

Entering Sleep or Activity Mode
...
Place the device firmly on the base station and make sure the base station is plugged into your computer.

While it's on the base station, press the button to see your charge level.
...
Syncing sends your activity data from your Tracker to Fitbit.com, so you can see your progress day-to-day.

Wireless Sync

The device syncs wirelessly anytime you're relatively motionless within 15 feet of an active base station.

Base Station

You can also sync by placing the device onto the base station. Make sure the base station is plugged in to your computer.
...
The Dashboard contains an overview of your **calorie burn**, **activity**, and **sleep** for the current day, showing up to the minute information when your device has been synced.

The right column shows detailed stats since you started using Fitbit, plus your profile information and friends' activity.

Logs

The more foods and activity you log, the more accurate your data will be.

Logging your foods, activity, sleep, weight, and more can be done under the **Tracker** tab, or by clicking one of the icons on your Dashboard:

Community Groups

Find people with similar goals and interests by joining a group.

Forums

Our member forums are for your questions and suggestions. If you have a question or problem it might have already been answered here!

Analytics

See how you rank against other users and your peers. These features are part of **Fitbit Premium**, where you can pay to see more detailed information about yourself and how you compare to others using Fitbit.
