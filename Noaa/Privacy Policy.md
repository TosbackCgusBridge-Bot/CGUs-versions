...
Enter Search Terms Forecasters predict a near- or above-normal 2018 Atlantic hurricane season New satellite data and model upgrades to give forecasts a boost AROUND NOAA // New, next-generation NOAA polar-orbiting satellite is now operational NOAA’s Annual Greenhouse Gas Index ticks up another notch Kilauea eruptions: The way the wind blows, so go the gas and the ash Video: Bad weather brings good opportunity to test forecast tools of the future
