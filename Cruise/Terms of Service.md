...
**ATOL licence** - we are member of ATOL  (Air Travel Organiser's License) no. 3385. www.Cruise.co.uk act as agents for licensed tour operators. the relevant ATOL number is displayed with each holiday shown and an ATOL certificate is sent with your booking confirmation. Firms selling air travel in the UK are required by law to hold ATOL's. ATOL's protect you from losing money, or being stranded abroad, when travel firms go bust. If it goes out of business, the CAA (Civil Aviation Authority) gives refunds to people who can't travel and pays for people abroad to finish their holidays and fly home. This protection is included in the price of a trip booked with an ATOL-holder. If your cruise package includes a flight organised by the Cruise Operator/Supplier, it is covered by the Cruise Operator's/Supplier's ATOL license as stated previously and this document will act as your ATOL Receipt. 
...
**"SHORE EXCURSIONS"  
**To save you money Cruise.co.uk now work with Viator. They are fully insured and work with many of the same tour companies that the cruise lines use. Please visit our website http://www.cruise.co.uk/cruise-guides/shore-excursions for all tour details and to make bookings.
...
If your booking includes any "ONBOARD CREDIT per cabin or per person, FREE CAR PARKING, FREE COACH OR RAIL TRANSFERS" these will be specified on the Cruise.co.uk confirmation invoice. 

Transfers are included (and provided by the cruise) only if you have booked a standard fly/cruise where we have booked both the flight/s &. cruise through the cruise line. If your booking is on a "Cruise Only basis", TRANSFERS are not included unless they are specified on the Cruise.co.uk confirmation invoice.

**GRATUITIES** - If you have pre-paid gratuities, then these will be specified on the Cruise.co.uk confirmation invoice.  
   
**"FLIGHTS"  
...
If you are travelling to **INDIA or CHINA,** all passengers require a visa, regardless of whether you are visiting on a cruise ship and do not intend to leave the ship or travelling by land. To obtain the visa or for more information, please click here or call CIBT Visa Service mentioning Cruise.co.uk for preferential rates on call 0844 800 4650 (Option 2). 
