...
If you do not know how to control or delete cookies, or would like to opt-out of receiving certain targeted ads based on your browsing history, we recommend that you visit http://www.networkadvertising.org/choices/ for detailed guidance, including opt-out instructions. Evidon’s Global Opt-Out tool is located at http://www.evidon.com/consumers-privacy/opt-out. If you would like to opt-out of Google Analytics for Display Advertisers and/or opt out of the customized Google Display Network, you may do so by visiting the Ads Preferences Manager. You may also wish to utilize the Google Analytics Opt-out Browser Add-on. For information on how to do this on the browser of your mobile device you will need to refer to your handset manual. Further information on the use of cookies and digital advertising may be found at http://aboutads.info
