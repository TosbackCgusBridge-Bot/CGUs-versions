...
**in-store cameras -**We use in-store cameras for security purposes and operational purposes such as measuring traffic patterns.        **using the information we collect**
...
*   To learn more about IBM Digital Analytics’ privacy practices, click here. You may opt-out of data collection by IBM Digital Analytics on jcpenney.com by clicking on the opt-out choice set forth below.  Please note that this opt-out only applies to data collected on jcpenney.com and not to data that might be collected by IBM Digital Analytics on any other sites.
...
**changes to this policy**     This policy was last updated on July 24, 2015 and included the following changes:
