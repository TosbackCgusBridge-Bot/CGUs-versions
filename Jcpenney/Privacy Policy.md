...
anonymous visitor setting allows IBM Digital Analytics to anonymously capture your basic site actions and to include the data in IBM Digital Analytics reporting. All actions are grouped within metrics for all other anonymous visitors. Anonymous visitors, click here.
...
cancel opt-out setting will again allow IBM Digital Analytics to capture all web actions, and includes the data collected in IBM Digital Analytics reporting. To cancel opt-out, click here.
...
*   Added information regarding Flash cookies (also known as Local Shared Objects)
*   Updated the section dealing with Analytics Services, to add a reference to Google Analytics, and reflect current names of other providers.
