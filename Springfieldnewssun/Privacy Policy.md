marimo.emit('writecapture19818814\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19818814", "widget\_prototype": "writecapture\_widget"}).