marimo.emit('writecapture96053519\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture96053519", "widget\_prototype": "writecapture\_widget"}).