marimo.emit('writecapture24464545\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture24464545", "widget\_prototype": "writecapture\_widget"}).