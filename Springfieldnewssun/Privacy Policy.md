marimo.emit('writecapture98787352\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture98787352", "widget\_prototype": "writecapture\_widget"}).