marimo.emit('writecapture59564464\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59564464", "widget\_prototype": "writecapture\_widget"}).