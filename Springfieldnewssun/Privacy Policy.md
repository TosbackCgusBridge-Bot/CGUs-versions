marimo.emit('writecapture37527602\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture37527602", "widget\_prototype": "writecapture\_widget"}).