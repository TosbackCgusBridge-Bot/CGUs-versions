marimo.emit('writecapture84267769\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture84267769", "widget\_prototype": "writecapture\_widget"}).