marimo.emit('writecapture36297988\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture36297988", "widget\_prototype": "writecapture\_widget"}).