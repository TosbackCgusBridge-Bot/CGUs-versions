marimo.emit('writecapture39413038\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39413038", "widget\_prototype": "writecapture\_widget"}).