marimo.emit('writecapture79436599\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79436599", "widget\_prototype": "writecapture\_widget"}).