marimo.emit('writecapture49673796\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture49673796", "widget\_prototype": "writecapture\_widget"}).