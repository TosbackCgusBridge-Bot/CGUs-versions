marimo.emit('writecapture50273901\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture50273901", "widget\_prototype": "writecapture\_widget"}).