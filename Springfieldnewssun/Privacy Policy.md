marimo.emit('writecapture55075807\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture55075807", "widget\_prototype": "writecapture\_widget"}).