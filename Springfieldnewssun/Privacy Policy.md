marimo.emit('writecapture19084304\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19084304", "widget\_prototype": "writecapture\_widget"}).