marimo.emit('writecapture17495511\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture17495511", "widget\_prototype": "writecapture\_widget"}).