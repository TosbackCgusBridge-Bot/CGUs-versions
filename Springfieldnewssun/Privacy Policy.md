marimo.emit('writecapture35370536\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35370536", "widget\_prototype": "writecapture\_widget"}).