marimo.emit('writecapture29586151\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture29586151", "widget\_prototype": "writecapture\_widget"}).