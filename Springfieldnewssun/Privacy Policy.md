marimo.emit('writecapture72210044\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture72210044", "widget\_prototype": "writecapture\_widget"}).