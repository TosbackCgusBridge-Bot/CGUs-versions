marimo.emit('writecapture86126581\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture86126581", "widget\_prototype": "writecapture\_widget"}).