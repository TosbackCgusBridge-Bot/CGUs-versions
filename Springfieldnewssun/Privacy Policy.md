marimo.emit('writecapture47929327\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture47929327", "widget\_prototype": "writecapture\_widget"}).