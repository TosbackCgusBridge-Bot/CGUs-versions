marimo.emit('writecapture29536459\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture29536459", "widget\_prototype": "writecapture\_widget"}).