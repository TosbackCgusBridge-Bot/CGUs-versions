marimo.emit('writecapture27189786\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture27189786", "widget\_prototype": "writecapture\_widget"}).