marimo.emit('writecapture39690984\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39690984", "widget\_prototype": "writecapture\_widget"}).