marimo.emit('writecapture6999938\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6999938", "widget\_prototype": "writecapture\_widget"}).