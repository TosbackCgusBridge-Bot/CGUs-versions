marimo.emit('writecapture53403869\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture53403869", "widget\_prototype": "writecapture\_widget"}).