marimo.emit('writecapture66337896\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE Privacy Policy$NEWLINE
...
$NEWLINE ", "id": "writecapture66337896", "widget\_prototype": "writecapture\_widget"}).