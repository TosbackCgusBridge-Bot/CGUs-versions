marimo.emit('writecapture93280213\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture93280213", "widget\_prototype": "writecapture\_widget"}).