marimo.emit('writecapture41064496\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture41064496", "widget\_prototype": "writecapture\_widget"}).