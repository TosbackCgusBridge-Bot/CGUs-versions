marimo.emit('writecapture77280002\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture77280002", "widget\_prototype": "writecapture\_widget"}).