marimo.emit('writecapture42771628\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42771628", "widget\_prototype": "writecapture\_widget"}).