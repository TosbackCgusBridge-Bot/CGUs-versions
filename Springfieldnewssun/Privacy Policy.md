marimo.emit('writecapture23988317\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture23988317", "widget\_prototype": "writecapture\_widget"}).