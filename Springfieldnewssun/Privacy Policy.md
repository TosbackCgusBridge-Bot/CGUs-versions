marimo.emit('writecapture30337376\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture30337376", "widget\_prototype": "writecapture\_widget"}).