marimo.emit('writecapture51059635\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture51059635", "widget\_prototype": "writecapture\_widget"}).