marimo.emit('writecapture1014609\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture1014609", "widget\_prototype": "writecapture\_widget"}).