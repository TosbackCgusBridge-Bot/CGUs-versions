marimo.emit('writecapture6989182\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6989182", "widget\_prototype": "writecapture\_widget"}).