marimo.emit('writecapture14959170\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture14959170", "widget\_prototype": "writecapture\_widget"}).