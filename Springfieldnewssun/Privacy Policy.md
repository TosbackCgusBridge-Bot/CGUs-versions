marimo.emit('writecapture15645285\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture15645285", "widget\_prototype": "writecapture\_widget"}).