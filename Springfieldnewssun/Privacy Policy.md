marimo.emit('writecapture5244490\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture5244490", "widget\_prototype": "writecapture\_widget"}).