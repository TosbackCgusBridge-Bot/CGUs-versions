marimo.emit('writecapture48812994\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture48812994", "widget\_prototype": "writecapture\_widget"}).