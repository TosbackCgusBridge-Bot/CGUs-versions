marimo.emit('writecapture40835702\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture40835702", "widget\_prototype": "writecapture\_widget"}).