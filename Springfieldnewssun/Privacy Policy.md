marimo.emit('writecapture35998774\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35998774", "widget\_prototype": "writecapture\_widget"}).