marimo.emit('writecapture3345411\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture3345411", "widget\_prototype": "writecapture\_widget"}).