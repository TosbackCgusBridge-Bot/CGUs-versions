marimo.emit('writecapture26589933\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture26589933", "widget\_prototype": "writecapture\_widget"}).