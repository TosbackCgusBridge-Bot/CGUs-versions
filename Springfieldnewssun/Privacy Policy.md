marimo.emit('writecapture72060587\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture72060587", "widget\_prototype": "writecapture\_widget"}).