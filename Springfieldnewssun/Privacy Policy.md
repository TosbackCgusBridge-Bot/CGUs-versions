marimo.emit('writecapture28988809\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28988809", "widget\_prototype": "writecapture\_widget"}).