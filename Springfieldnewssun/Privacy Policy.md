marimo.emit('writecapture33590149\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture33590149", "widget\_prototype": "writecapture\_widget"}).