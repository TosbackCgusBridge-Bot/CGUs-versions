marimo.emit('writecapture25677090\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture25677090", "widget\_prototype": "writecapture\_widget"}).