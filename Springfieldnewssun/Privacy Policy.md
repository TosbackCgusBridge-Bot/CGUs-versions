marimo.emit('writecapture11551356\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11551356", "widget\_prototype": "writecapture\_widget"}).