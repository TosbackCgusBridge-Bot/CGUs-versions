marimo.emit('writecapture47156594\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture47156594", "widget\_prototype": "writecapture\_widget"}).