marimo.emit('writecapture41573929\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture41573929", "widget\_prototype": "writecapture\_widget"}).