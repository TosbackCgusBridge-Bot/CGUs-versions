marimo.emit('writecapture13885801\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture13885801", "widget\_prototype": "writecapture\_widget"}).