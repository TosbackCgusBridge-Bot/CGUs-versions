marimo.emit('writecapture85685739\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture85685739", "widget\_prototype": "writecapture\_widget"}).