marimo.emit('writecapture39289322\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39289322", "widget\_prototype": "writecapture\_widget"}).