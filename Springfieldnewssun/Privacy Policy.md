marimo.emit('writecapture59398051\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59398051", "widget\_prototype": "writecapture\_widget"}).