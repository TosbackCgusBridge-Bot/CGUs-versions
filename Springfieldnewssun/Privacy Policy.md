marimo.emit('writecapture78833945\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78833945", "widget\_prototype": "writecapture\_widget"}).