marimo.emit('writecapture15670173\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture15670173", "widget\_prototype": "writecapture\_widget"}).