marimo.emit('writecapture70101502\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture70101502", "widget\_prototype": "writecapture\_widget"}).