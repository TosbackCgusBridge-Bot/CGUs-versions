marimo.emit('writecapture88991791\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture88991791", "widget\_prototype": "writecapture\_widget"}).