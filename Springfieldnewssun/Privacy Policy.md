marimo.emit('writecapture13839051\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture13839051", "widget\_prototype": "writecapture\_widget"}).