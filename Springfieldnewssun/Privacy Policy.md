marimo.emit('writecapture18987294\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture18987294", "widget\_prototype": "writecapture\_widget"}).