marimo.emit('writecapture43111633\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture43111633", "widget\_prototype": "writecapture\_widget"}).