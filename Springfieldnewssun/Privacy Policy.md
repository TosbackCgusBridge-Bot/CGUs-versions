marimo.emit('writecapture75332678\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture75332678", "widget\_prototype": "writecapture\_widget"}).