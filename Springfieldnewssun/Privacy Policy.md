marimo.emit('writecapture7995339\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture7995339", "widget\_prototype": "writecapture\_widget"}).