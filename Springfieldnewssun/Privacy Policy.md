marimo.emit('writecapture99003441\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99003441", "widget\_prototype": "writecapture\_widget"}).