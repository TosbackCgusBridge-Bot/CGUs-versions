marimo.emit('writecapture6847609\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6847609", "widget\_prototype": "writecapture\_widget"}).