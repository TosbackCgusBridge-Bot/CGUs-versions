marimo.emit('writecapture15755732\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
**CMG\\u2019s Adherence to Self-Regulatory Principles for Online Behavioral Advertisin**g. CMG adheres to the Self-Regulatory Principles for Online Behavioral Advertising of the Digital Advertising Alliance. To learn more about the Principles and your choices when it comes to the use of online behavioral advertising data by advertisers and ad servers across the Internet, visit aboutads.info.
...
$NEWLINE ", "id": "writecapture15755732", "widget\_prototype": "writecapture\_widget"}).