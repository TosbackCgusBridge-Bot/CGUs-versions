marimo.emit('writecapture57443796\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture57443796", "widget\_prototype": "writecapture\_widget"}).