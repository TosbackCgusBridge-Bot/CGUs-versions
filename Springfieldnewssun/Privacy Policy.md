marimo.emit('writecapture20769360\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20769360", "widget\_prototype": "writecapture\_widget"}).