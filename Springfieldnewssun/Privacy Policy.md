marimo.emit('writecapture82808974\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture82808974", "widget\_prototype": "writecapture\_widget"}).