marimo.emit('writecapture86760819\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture86760819", "widget\_prototype": "writecapture\_widget"}).