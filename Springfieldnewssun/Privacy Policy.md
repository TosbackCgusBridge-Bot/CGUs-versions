marimo.emit('writecapture99652773\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99652773", "widget\_prototype": "writecapture\_widget"}).