marimo.emit('writecapture69359910\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture69359910", "widget\_prototype": "writecapture\_widget"}).