marimo.emit('writecapture88271160\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture88271160", "widget\_prototype": "writecapture\_widget"}).