marimo.emit('writecapture37780950\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture37780950", "widget\_prototype": "writecapture\_widget"}).