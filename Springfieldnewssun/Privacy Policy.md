marimo.emit('writecapture43082571\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture43082571", "widget\_prototype": "writecapture\_widget"}).