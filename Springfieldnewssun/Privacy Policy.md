marimo.emit('writecapture7067474\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7067474", "widget\_prototype": "writecapture\_widget"}).