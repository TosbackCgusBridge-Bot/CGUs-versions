marimo.emit('writecapture77147447\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture77147447", "widget\_prototype": "writecapture\_widget"}).