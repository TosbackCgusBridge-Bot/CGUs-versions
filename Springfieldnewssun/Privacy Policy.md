marimo.emit('writecapture11419342\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11419342", "widget\_prototype": "writecapture\_widget"}).