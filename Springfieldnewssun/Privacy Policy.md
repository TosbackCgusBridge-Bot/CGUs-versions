marimo.emit('writecapture78196915\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78196915", "widget\_prototype": "writecapture\_widget"}).