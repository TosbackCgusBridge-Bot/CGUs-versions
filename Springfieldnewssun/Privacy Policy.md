marimo.emit('writecapture85344847\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture85344847", "widget\_prototype": "writecapture\_widget"}).