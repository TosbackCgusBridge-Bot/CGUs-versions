marimo.emit('writecapture25799465\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture25799465", "widget\_prototype": "writecapture\_widget"}).