marimo.emit('writecapture4952628\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture4952628", "widget\_prototype": "writecapture\_widget"}).