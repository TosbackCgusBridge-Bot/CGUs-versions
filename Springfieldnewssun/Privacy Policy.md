marimo.emit('writecapture16063007\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16063007", "widget\_prototype": "writecapture\_widget"}).