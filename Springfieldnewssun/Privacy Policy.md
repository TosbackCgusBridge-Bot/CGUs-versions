marimo.emit('writecapture28444235\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28444235", "widget\_prototype": "writecapture\_widget"}).