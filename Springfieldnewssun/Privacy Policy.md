marimo.emit('writecapture24402035\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture24402035", "widget\_prototype": "writecapture\_widget"}).