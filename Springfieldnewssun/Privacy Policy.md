marimo.emit('writecapture72513450\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture72513450", "widget\_prototype": "writecapture\_widget"}).