marimo.emit('writecapture78779509\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78779509", "widget\_prototype": "writecapture\_widget"}).