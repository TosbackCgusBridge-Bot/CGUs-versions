marimo.emit('writecapture91228048\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture91228048", "widget\_prototype": "writecapture\_widget"}).