marimo.emit('writecapture62488400\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture62488400", "widget\_prototype": "writecapture\_widget"}).