marimo.emit('writecapture16976062\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16976062", "widget\_prototype": "writecapture\_widget"}).