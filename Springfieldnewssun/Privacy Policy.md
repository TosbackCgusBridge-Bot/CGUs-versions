marimo.emit('writecapture93979178\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture93979178", "widget\_prototype": "writecapture\_widget"}).