marimo.emit('writecapture7247394\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7247394", "widget\_prototype": "writecapture\_widget"}).