marimo.emit('writecapture61348372\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture61348372", "widget\_prototype": "writecapture\_widget"}).