marimo.emit('writecapture98040510\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture98040510", "widget\_prototype": "writecapture\_widget"}).