marimo.emit('writecapture42227628\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42227628", "widget\_prototype": "writecapture\_widget"}).