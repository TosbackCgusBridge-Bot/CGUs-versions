marimo.emit('writecapture13033652\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture13033652", "widget\_prototype": "writecapture\_widget"}).