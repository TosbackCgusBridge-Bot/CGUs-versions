marimo.emit('writecapture9916001\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture9916001", "widget\_prototype": "writecapture\_widget"}).