marimo.emit('writecapture40286616\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture40286616", "widget\_prototype": "writecapture\_widget"}).