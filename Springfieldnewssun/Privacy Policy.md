marimo.emit('writecapture60833542\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture60833542", "widget\_prototype": "writecapture\_widget"}).