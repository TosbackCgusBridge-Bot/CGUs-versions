marimo.emit('writecapture59025995\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59025995", "widget\_prototype": "writecapture\_widget"}).