marimo.emit('writecapture29054315\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture29054315", "widget\_prototype": "writecapture\_widget"}).