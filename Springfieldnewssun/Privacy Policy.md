marimo.emit('writecapture34802296\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture34802296", "widget\_prototype": "writecapture\_widget"}).