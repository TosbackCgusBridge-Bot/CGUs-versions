marimo.emit('writecapture46985721\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture46985721", "widget\_prototype": "writecapture\_widget"}).