marimo.emit('writecapture52232568\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture52232568", "widget\_prototype": "writecapture\_widget"}).