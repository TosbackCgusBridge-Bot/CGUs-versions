marimo.emit('writecapture79061088\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79061088", "widget\_prototype": "writecapture\_widget"}).