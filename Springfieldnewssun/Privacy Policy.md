marimo.emit('writecapture50084709\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture50084709", "widget\_prototype": "writecapture\_widget"}).