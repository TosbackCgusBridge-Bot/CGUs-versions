marimo.emit('writecapture11367737\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11367737", "widget\_prototype": "writecapture\_widget"}).