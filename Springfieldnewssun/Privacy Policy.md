marimo.emit('writecapture25118359\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture25118359", "widget\_prototype": "writecapture\_widget"}).