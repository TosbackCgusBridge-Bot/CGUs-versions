marimo.emit('writecapture28485696\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28485696", "widget\_prototype": "writecapture\_widget"}).