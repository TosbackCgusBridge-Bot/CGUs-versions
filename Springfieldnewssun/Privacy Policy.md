marimo.emit('writecapture13144629\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture13144629", "widget\_prototype": "writecapture\_widget"}).