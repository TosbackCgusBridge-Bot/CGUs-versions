marimo.emit('writecapture49719675\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture49719675", "widget\_prototype": "writecapture\_widget"}).