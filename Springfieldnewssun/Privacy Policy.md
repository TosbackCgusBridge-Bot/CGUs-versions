marimo.emit('writecapture38875466\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture38875466", "widget\_prototype": "writecapture\_widget"}).