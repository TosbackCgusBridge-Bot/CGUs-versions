marimo.emit('writecapture56442087\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture56442087", "widget\_prototype": "writecapture\_widget"}).