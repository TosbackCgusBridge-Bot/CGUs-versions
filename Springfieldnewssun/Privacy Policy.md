marimo.emit('writecapture12248267\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture12248267", "widget\_prototype": "writecapture\_widget"}).