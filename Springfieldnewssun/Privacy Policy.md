marimo.emit('writecapture12422070\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture12422070", "widget\_prototype": "writecapture\_widget"}).