marimo.emit('writecapture8722442\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture8722442", "widget\_prototype": "writecapture\_widget"}).