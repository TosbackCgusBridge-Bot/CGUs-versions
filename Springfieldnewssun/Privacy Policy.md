marimo.emit('writecapture6305363\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6305363", "widget\_prototype": "writecapture\_widget"}).