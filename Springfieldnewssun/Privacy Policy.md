marimo.emit('writecapture65534593\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture65534593", "widget\_prototype": "writecapture\_widget"}).