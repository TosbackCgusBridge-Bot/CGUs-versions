marimo.emit('writecapture27059904\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture27059904", "widget\_prototype": "writecapture\_widget"}).