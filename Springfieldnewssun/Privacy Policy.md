marimo.emit('writecapture62861413\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture62861413", "widget\_prototype": "writecapture\_widget"}).