marimo.emit('writecapture28896567\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28896567", "widget\_prototype": "writecapture\_widget"}).