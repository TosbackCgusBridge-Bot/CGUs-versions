marimo.emit('writecapture89537617\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture89537617", "widget\_prototype": "writecapture\_widget"}).