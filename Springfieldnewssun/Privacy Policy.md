marimo.emit('writecapture14106809\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture14106809", "widget\_prototype": "writecapture\_widget"}).