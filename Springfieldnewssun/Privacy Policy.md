marimo.emit('writecapture34509666\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture34509666", "widget\_prototype": "writecapture\_widget"}).