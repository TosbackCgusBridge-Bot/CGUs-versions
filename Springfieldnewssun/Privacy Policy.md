marimo.emit('writecapture20251267\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20251267", "widget\_prototype": "writecapture\_widget"}).