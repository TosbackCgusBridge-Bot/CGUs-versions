marimo.emit('writecapture60872171\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture60872171", "widget\_prototype": "writecapture\_widget"}).