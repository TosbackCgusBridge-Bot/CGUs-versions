marimo.emit('writecapture15426156\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture15426156", "widget\_prototype": "writecapture\_widget"}).