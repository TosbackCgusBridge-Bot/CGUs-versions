marimo.emit('writecapture52877754\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture52877754", "widget\_prototype": "writecapture\_widget"}).