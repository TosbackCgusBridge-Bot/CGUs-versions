marimo.emit('writecapture9688069\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture9688069", "widget\_prototype": "writecapture\_widget"}).