marimo.emit('writecapture38241427\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture38241427", "widget\_prototype": "writecapture\_widget"}).