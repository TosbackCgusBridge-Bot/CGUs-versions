marimo.emit('writecapture94634396\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture94634396", "widget\_prototype": "writecapture\_widget"}).