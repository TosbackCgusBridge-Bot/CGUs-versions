marimo.emit('writecapture15324610\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture15324610", "widget\_prototype": "writecapture\_widget"}).