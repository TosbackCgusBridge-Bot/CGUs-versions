marimo.emit('writecapture58845268\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture58845268", "widget\_prototype": "writecapture\_widget"}).