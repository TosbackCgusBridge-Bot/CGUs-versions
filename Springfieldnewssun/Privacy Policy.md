marimo.emit('writecapture17970541\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture17970541", "widget\_prototype": "writecapture\_widget"}).