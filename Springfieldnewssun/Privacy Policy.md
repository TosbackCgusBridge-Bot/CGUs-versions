marimo.emit('writecapture57318015\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture57318015", "widget\_prototype": "writecapture\_widget"}).