marimo.emit('writecapture15760856\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture15760856", "widget\_prototype": "writecapture\_widget"}).