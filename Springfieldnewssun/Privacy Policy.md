marimo.emit('writecapture13533415\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture13533415", "widget\_prototype": "writecapture\_widget"}).