marimo.emit('writecapture20949365\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20949365", "widget\_prototype": "writecapture\_widget"}).