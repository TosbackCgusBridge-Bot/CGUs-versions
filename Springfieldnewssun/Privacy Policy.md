marimo.emit('writecapture85592592\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture85592592", "widget\_prototype": "writecapture\_widget"}).