marimo.emit('writecapture39688630\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39688630", "widget\_prototype": "writecapture\_widget"}).