marimo.emit('writecapture54795083\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture54795083", "widget\_prototype": "writecapture\_widget"}).