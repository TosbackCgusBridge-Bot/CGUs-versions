marimo.emit('writecapture31853563\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture31853563", "widget\_prototype": "writecapture\_widget"}).