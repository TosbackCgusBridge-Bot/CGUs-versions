marimo.emit('writecapture35496156\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35496156", "widget\_prototype": "writecapture\_widget"}).