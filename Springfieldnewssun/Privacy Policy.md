marimo.emit('writecapture58025898\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture58025898", "widget\_prototype": "writecapture\_widget"}).