marimo.emit('writecapture23510328\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture23510328", "widget\_prototype": "writecapture\_widget"}).