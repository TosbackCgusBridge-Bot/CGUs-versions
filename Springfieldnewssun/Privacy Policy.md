marimo.emit('writecapture91447668\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture91447668", "widget\_prototype": "writecapture\_widget"}).