marimo.emit('writecapture68997374\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture68997374", "widget\_prototype": "writecapture\_widget"}).