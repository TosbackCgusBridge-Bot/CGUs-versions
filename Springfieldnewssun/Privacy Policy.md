marimo.emit('writecapture88003461\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture88003461", "widget\_prototype": "writecapture\_widget"}).