marimo.emit('writecapture52809735\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture52809735", "widget\_prototype": "writecapture\_widget"}).