marimo.emit('writecapture63322455\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture63322455", "widget\_prototype": "writecapture\_widget"}).