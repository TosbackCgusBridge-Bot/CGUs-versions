marimo.emit('writecapture50430029\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture50430029", "widget\_prototype": "writecapture\_widget"}).