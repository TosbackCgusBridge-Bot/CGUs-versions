marimo.emit('writecapture87328813\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture87328813", "widget\_prototype": "writecapture\_widget"}).