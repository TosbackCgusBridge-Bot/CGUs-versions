marimo.emit('writecapture67504461\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture67504461", "widget\_prototype": "writecapture\_widget"}).