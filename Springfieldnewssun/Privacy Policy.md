marimo.emit('writecapture93777820\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture93777820", "widget\_prototype": "writecapture\_widget"}).