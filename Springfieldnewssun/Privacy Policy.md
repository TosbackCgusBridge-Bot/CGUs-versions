marimo.emit('writecapture45042052\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture45042052", "widget\_prototype": "writecapture\_widget"}).