marimo.emit('writecapture897781\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture897781", "widget\_prototype": "writecapture\_widget"}).