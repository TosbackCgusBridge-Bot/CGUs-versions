marimo.emit('writecapture14846207\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture14846207", "widget\_prototype": "writecapture\_widget"}).