marimo.emit('writecapture23000431\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture23000431", "widget\_prototype": "writecapture\_widget"}).