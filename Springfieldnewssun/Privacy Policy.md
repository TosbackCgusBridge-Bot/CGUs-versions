marimo.emit('writecapture32225438\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture32225438", "widget\_prototype": "writecapture\_widget"}).