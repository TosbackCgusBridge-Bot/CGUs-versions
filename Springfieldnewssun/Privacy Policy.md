marimo.emit('writecapture63652580\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture63652580", "widget\_prototype": "writecapture\_widget"}).