marimo.emit('writecapture11424883\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11424883", "widget\_prototype": "writecapture\_widget"}).