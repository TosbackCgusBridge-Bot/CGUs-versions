marimo.emit('writecapture13917172\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture13917172", "widget\_prototype": "writecapture\_widget"}).