marimo.emit('writecapture25226180\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture25226180", "widget\_prototype": "writecapture\_widget"}).