marimo.emit('writecapture37589447\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture37589447", "widget\_prototype": "writecapture\_widget"}).