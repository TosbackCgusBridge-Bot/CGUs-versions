marimo.emit('writecapture7406562\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7406562", "widget\_prototype": "writecapture\_widget"}).