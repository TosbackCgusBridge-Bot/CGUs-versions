marimo.emit('writecapture66111339\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture66111339", "widget\_prototype": "writecapture\_widget"}).