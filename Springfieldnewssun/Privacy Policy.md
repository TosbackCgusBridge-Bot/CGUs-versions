marimo.emit('writecapture87677490\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture87677490", "widget\_prototype": "writecapture\_widget"}).