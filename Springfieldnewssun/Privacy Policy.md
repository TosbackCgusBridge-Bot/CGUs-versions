marimo.emit('writecapture23063305\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture23063305", "widget\_prototype": "writecapture\_widget"}).