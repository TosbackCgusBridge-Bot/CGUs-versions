marimo.emit('writecapture6406123\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6406123", "widget\_prototype": "writecapture\_widget"}).