marimo.emit('writecapture35305467\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35305467", "widget\_prototype": "writecapture\_widget"}).