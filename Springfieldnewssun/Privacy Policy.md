marimo.emit('writecapture84755133\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture84755133", "widget\_prototype": "writecapture\_widget"}).