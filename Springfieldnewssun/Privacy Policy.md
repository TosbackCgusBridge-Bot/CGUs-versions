marimo.emit('writecapture42808762\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42808762", "widget\_prototype": "writecapture\_widget"}).