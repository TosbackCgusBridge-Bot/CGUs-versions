marimo.emit('writecapture17432906\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture17432906", "widget\_prototype": "writecapture\_widget"}).