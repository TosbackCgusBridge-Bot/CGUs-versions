marimo.emit('writecapture95693438\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture95693438", "widget\_prototype": "writecapture\_widget"}).