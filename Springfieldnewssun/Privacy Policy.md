marimo.emit('writecapture14558693\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture14558693", "widget\_prototype": "writecapture\_widget"}).