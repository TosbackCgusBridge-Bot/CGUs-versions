marimo.emit('writecapture76331612\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture76331612", "widget\_prototype": "writecapture\_widget"}).