marimo.emit('writecapture55431793\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture55431793", "widget\_prototype": "writecapture\_widget"}).