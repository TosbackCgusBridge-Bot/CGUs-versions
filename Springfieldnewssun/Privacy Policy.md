marimo.emit('writecapture99908962\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99908962", "widget\_prototype": "writecapture\_widget"}).