marimo.emit('writecapture39053812\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39053812", "widget\_prototype": "writecapture\_widget"}).