marimo.emit('writecapture66992063\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture66992063", "widget\_prototype": "writecapture\_widget"}).