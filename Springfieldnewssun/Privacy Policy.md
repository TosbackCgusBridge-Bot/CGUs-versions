marimo.emit('writecapture64513341\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64513341", "widget\_prototype": "writecapture\_widget"}).