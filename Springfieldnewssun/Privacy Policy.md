marimo.emit('writecapture70775400\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture70775400", "widget\_prototype": "writecapture\_widget"}).