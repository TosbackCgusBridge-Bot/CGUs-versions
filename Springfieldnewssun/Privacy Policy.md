marimo.emit('writecapture59166099\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59166099", "widget\_prototype": "writecapture\_widget"}).