marimo.emit('writecapture3049827\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture3049827", "widget\_prototype": "writecapture\_widget"}).