marimo.emit('writecapture30661353\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture30661353", "widget\_prototype": "writecapture\_widget"}).