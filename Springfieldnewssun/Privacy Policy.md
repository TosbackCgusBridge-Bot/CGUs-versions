marimo.emit('writecapture54295412\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture54295412", "widget\_prototype": "writecapture\_widget"}).