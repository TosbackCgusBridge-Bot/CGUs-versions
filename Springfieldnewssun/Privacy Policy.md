marimo.emit('writecapture7811\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7811", "widget\_prototype": "writecapture\_widget"}).