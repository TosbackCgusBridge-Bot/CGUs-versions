marimo.emit('writecapture82946255\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture82946255", "widget\_prototype": "writecapture\_widget"}).