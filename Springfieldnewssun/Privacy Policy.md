marimo.emit('writecapture53054028\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture53054028", "widget\_prototype": "writecapture\_widget"}).