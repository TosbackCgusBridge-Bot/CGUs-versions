marimo.emit('writecapture98081285\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture98081285", "widget\_prototype": "writecapture\_widget"}).