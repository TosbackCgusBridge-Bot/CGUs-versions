marimo.emit('writecapture47994528\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture47994528", "widget\_prototype": "writecapture\_widget"}).