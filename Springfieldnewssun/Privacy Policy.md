marimo.emit('writecapture2229779\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture2229779", "widget\_prototype": "writecapture\_widget"}).