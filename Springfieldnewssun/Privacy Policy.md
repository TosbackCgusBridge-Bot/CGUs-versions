marimo.emit('writecapture27214129\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture27214129", "widget\_prototype": "writecapture\_widget"}).