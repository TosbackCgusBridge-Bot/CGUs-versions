marimo.emit('writecapture40509423\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture40509423", "widget\_prototype": "writecapture\_widget"}).