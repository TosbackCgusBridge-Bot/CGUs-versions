marimo.emit('writecapture86095002\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture86095002", "widget\_prototype": "writecapture\_widget"}).