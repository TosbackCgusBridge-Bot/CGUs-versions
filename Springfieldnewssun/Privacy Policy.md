marimo.emit('writecapture56898823\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture56898823", "widget\_prototype": "writecapture\_widget"}).