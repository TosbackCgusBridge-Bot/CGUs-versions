marimo.emit('writecapture78345637\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78345637", "widget\_prototype": "writecapture\_widget"}).