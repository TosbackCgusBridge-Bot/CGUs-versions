marimo.emit('writecapture67515808\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture67515808", "widget\_prototype": "writecapture\_widget"}).