marimo.emit('writecapture60787801\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture60787801", "widget\_prototype": "writecapture\_widget"}).