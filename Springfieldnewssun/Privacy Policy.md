marimo.emit('writecapture79979679\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79979679", "widget\_prototype": "writecapture\_widget"}).