marimo.emit('writecapture11167266\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11167266", "widget\_prototype": "writecapture\_widget"}).