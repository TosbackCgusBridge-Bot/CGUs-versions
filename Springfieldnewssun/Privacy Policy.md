marimo.emit('writecapture59422445\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59422445", "widget\_prototype": "writecapture\_widget"}).