marimo.emit('writecapture35267807\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35267807", "widget\_prototype": "writecapture\_widget"}).