marimo.emit('writecapture33102208\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture33102208", "widget\_prototype": "writecapture\_widget"}).