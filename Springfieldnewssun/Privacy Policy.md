marimo.emit('writecapture17161982\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture17161982", "widget\_prototype": "writecapture\_widget"}).