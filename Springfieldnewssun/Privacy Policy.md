marimo.emit('writecapture20013433\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20013433", "widget\_prototype": "writecapture\_widget"}).