marimo.emit('writecapture80096630\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture80096630", "widget\_prototype": "writecapture\_widget"}).