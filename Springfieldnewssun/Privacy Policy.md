marimo.emit('writecapture10206291\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture10206291", "widget\_prototype": "writecapture\_widget"}).