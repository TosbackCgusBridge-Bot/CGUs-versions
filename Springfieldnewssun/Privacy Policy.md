marimo.emit('writecapture40634953\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture40634953", "widget\_prototype": "writecapture\_widget"}).