marimo.emit('writecapture82524482\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture82524482", "widget\_prototype": "writecapture\_widget"}).