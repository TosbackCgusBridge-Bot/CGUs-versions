marimo.emit('writecapture33905250\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture33905250", "widget\_prototype": "writecapture\_widget"}).