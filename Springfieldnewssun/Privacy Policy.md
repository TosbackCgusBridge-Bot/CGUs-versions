marimo.emit('writecapture65233326\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE Privacy Policy$NEWLINE
...
$NEWLINE ", "id": "writecapture65233326", "widget\_prototype": "writecapture\_widget"}).