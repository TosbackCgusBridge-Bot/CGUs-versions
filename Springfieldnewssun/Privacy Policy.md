marimo.emit('writecapture68578993\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture68578993", "widget\_prototype": "writecapture\_widget"}).