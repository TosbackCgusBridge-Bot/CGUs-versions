marimo.emit('writecapture2082705\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture2082705", "widget\_prototype": "writecapture\_widget"}).