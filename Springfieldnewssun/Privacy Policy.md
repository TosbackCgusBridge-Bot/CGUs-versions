marimo.emit('writecapture10070514\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture10070514", "widget\_prototype": "writecapture\_widget"}).