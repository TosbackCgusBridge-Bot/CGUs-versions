marimo.emit('writecapture68791783\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture68791783", "widget\_prototype": "writecapture\_widget"}).