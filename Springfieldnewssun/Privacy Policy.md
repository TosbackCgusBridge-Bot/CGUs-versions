marimo.emit('writecapture13025206\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture13025206", "widget\_prototype": "writecapture\_widget"}).