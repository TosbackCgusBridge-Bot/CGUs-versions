marimo.emit('writecapture31150820\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture31150820", "widget\_prototype": "writecapture\_widget"}).