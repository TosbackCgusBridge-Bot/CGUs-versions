marimo.emit('writecapture41588183\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture41588183", "widget\_prototype": "writecapture\_widget"}).