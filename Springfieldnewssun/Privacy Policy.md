marimo.emit('writecapture43466729\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture43466729", "widget\_prototype": "writecapture\_widget"}).