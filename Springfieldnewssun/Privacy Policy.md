marimo.emit('writecapture11262609\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11262609", "widget\_prototype": "writecapture\_widget"}).