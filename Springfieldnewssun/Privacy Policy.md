marimo.emit('writecapture4206027\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture4206027", "widget\_prototype": "writecapture\_widget"}).