marimo.emit('writecapture61172537\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture61172537", "widget\_prototype": "writecapture\_widget"}).