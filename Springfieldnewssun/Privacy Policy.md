marimo.emit('writecapture9910\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture9910", "widget\_prototype": "writecapture\_widget"}).