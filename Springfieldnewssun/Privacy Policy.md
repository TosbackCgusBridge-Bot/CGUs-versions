marimo.emit('writecapture43266340\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture43266340", "widget\_prototype": "writecapture\_widget"}).