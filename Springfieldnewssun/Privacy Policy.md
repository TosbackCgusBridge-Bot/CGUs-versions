marimo.emit('writecapture92476240\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture92476240", "widget\_prototype": "writecapture\_widget"}).