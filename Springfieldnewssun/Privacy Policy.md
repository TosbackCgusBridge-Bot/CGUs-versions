marimo.emit('writecapture89439762\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture89439762", "widget\_prototype": "writecapture\_widget"}).