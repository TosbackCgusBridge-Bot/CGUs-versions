marimo.emit('writecapture58013287\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture58013287", "widget\_prototype": "writecapture\_widget"}).