marimo.emit('writecapture72873904\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture72873904", "widget\_prototype": "writecapture\_widget"}).