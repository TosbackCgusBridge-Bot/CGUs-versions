marimo.emit('writecapture87482608\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture87482608", "widget\_prototype": "writecapture\_widget"}).