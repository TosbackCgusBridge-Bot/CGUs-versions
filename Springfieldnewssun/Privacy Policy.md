marimo.emit('writecapture64242516\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64242516", "widget\_prototype": "writecapture\_widget"}).