marimo.emit('writecapture4385509\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture4385509", "widget\_prototype": "writecapture\_widget"}).