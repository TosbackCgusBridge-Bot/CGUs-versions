marimo.emit('writecapture11389307\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11389307", "widget\_prototype": "writecapture\_widget"}).