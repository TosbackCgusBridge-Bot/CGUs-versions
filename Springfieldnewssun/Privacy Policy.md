marimo.emit('writecapture80639197\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture80639197", "widget\_prototype": "writecapture\_widget"}).