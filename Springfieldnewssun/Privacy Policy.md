marimo.emit('writecapture12052094\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture12052094", "widget\_prototype": "writecapture\_widget"}).