marimo.emit('writecapture46326850\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture46326850", "widget\_prototype": "writecapture\_widget"}).