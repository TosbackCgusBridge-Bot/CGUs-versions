marimo.emit('writecapture16102196\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16102196", "widget\_prototype": "writecapture\_widget"}).