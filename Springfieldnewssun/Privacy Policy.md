marimo.emit('writecapture5626909\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture5626909", "widget\_prototype": "writecapture\_widget"}).