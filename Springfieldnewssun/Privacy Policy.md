marimo.emit('writecapture89310584\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture89310584", "widget\_prototype": "writecapture\_widget"}).