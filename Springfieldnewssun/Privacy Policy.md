marimo.emit('writecapture64373205\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64373205", "widget\_prototype": "writecapture\_widget"}).