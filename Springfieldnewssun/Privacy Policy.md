marimo.emit('writecapture52010205\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture52010205", "widget\_prototype": "writecapture\_widget"}).