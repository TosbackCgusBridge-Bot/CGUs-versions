marimo.emit('writecapture21960182\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture21960182", "widget\_prototype": "writecapture\_widget"}).