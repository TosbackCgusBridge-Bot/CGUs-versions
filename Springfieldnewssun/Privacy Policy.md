marimo.emit('writecapture36753607\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture36753607", "widget\_prototype": "writecapture\_widget"}).