marimo.emit('writecapture32087479\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture32087479", "widget\_prototype": "writecapture\_widget"}).