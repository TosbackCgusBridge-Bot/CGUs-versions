marimo.emit('writecapture35443104\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35443104", "widget\_prototype": "writecapture\_widget"}).