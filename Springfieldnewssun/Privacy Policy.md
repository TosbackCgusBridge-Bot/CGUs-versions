marimo.emit('writecapture11908487\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11908487", "widget\_prototype": "writecapture\_widget"}).