marimo.emit('writecapture36160216\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture36160216", "widget\_prototype": "writecapture\_widget"}).