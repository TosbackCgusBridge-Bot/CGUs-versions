marimo.emit('writecapture81664486\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture81664486", "widget\_prototype": "writecapture\_widget"}).