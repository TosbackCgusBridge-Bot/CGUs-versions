marimo.emit('writecapture79880955\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79880955", "widget\_prototype": "writecapture\_widget"}).