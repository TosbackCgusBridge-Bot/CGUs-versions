marimo.emit('writecapture30200815\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture30200815", "widget\_prototype": "writecapture\_widget"}).