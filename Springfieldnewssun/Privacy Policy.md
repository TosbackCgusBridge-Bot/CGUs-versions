marimo.emit('writecapture39267460\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39267460", "widget\_prototype": "writecapture\_widget"}).