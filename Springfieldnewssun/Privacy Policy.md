marimo.emit('writecapture49225322\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture49225322", "widget\_prototype": "writecapture\_widget"}).