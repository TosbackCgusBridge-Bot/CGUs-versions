marimo.emit('writecapture2431162\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture2431162", "widget\_prototype": "writecapture\_widget"}).