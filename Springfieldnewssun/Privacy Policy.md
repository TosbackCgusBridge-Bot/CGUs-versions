marimo.emit('writecapture91000242\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture91000242", "widget\_prototype": "writecapture\_widget"}).