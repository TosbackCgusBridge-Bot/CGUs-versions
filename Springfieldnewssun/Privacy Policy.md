marimo.emit('writecapture9216117\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture9216117", "widget\_prototype": "writecapture\_widget"}).