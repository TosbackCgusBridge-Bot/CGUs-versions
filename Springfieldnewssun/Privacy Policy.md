marimo.emit('writecapture6370691\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6370691", "widget\_prototype": "writecapture\_widget"}).