marimo.emit('writecapture86734181\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture86734181", "widget\_prototype": "writecapture\_widget"}).