marimo.emit('writecapture29703649\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture29703649", "widget\_prototype": "writecapture\_widget"}).