marimo.emit('writecapture43850800\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture43850800", "widget\_prototype": "writecapture\_widget"}).