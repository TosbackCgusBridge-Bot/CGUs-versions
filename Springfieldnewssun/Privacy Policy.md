marimo.emit('writecapture28837844\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28837844", "widget\_prototype": "writecapture\_widget"}).