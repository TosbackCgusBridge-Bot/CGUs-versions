marimo.emit('writecapture56216710\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture56216710", "widget\_prototype": "writecapture\_widget"}).