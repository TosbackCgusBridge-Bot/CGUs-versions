marimo.emit('writecapture7735853\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7735853", "widget\_prototype": "writecapture\_widget"}).