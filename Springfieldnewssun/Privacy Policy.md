marimo.emit('writecapture42391763\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42391763", "widget\_prototype": "writecapture\_widget"}).