marimo.emit('writecapture42447406\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42447406", "widget\_prototype": "writecapture\_widget"}).