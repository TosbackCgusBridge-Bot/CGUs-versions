marimo.emit('writecapture74786129\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture74786129", "widget\_prototype": "writecapture\_widget"}).