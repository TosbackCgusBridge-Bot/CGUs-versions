marimo.emit('writecapture81956574\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture81956574", "widget\_prototype": "writecapture\_widget"}).