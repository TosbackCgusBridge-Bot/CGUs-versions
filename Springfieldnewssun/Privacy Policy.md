marimo.emit('writecapture2811397\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture2811397", "widget\_prototype": "writecapture\_widget"}).