marimo.emit('writecapture90283154\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture90283154", "widget\_prototype": "writecapture\_widget"}).