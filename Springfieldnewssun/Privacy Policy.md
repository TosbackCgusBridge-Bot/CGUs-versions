marimo.emit('writecapture57482244\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture57482244", "widget\_prototype": "writecapture\_widget"}).