marimo.emit('writecapture65724884\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture65724884", "widget\_prototype": "writecapture\_widget"}).