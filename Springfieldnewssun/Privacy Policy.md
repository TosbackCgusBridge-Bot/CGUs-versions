marimo.emit('writecapture96461442\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture96461442", "widget\_prototype": "writecapture\_widget"}).