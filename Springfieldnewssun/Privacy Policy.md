marimo.emit('writecapture47476485\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture47476485", "widget\_prototype": "writecapture\_widget"}).