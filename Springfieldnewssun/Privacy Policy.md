marimo.emit('writecapture44158845\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture44158845", "widget\_prototype": "writecapture\_widget"}).