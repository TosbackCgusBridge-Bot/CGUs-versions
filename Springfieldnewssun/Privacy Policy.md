marimo.emit('writecapture5549352\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture5549352", "widget\_prototype": "writecapture\_widget"}).