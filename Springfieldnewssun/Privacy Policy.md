marimo.emit('writecapture6066215\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6066215", "widget\_prototype": "writecapture\_widget"}).