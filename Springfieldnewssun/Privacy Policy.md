marimo.emit('writecapture4267979\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture4267979", "widget\_prototype": "writecapture\_widget"}).