marimo.emit('writecapture37527294\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture37527294", "widget\_prototype": "writecapture\_widget"}).