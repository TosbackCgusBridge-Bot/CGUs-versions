marimo.emit('writecapture64197962\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64197962", "widget\_prototype": "writecapture\_widget"}).