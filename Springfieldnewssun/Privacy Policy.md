marimo.emit('writecapture48582320\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture48582320", "widget\_prototype": "writecapture\_widget"}).