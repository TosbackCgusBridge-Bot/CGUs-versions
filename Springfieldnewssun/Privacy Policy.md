marimo.emit('writecapture71062338\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture71062338", "widget\_prototype": "writecapture\_widget"}).