marimo.emit('writecapture78736320\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture78736320", "widget\_prototype": "writecapture\_widget"}).