marimo.emit('writecapture59038027\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59038027", "widget\_prototype": "writecapture\_widget"}).