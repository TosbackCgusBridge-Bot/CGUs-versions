marimo.emit('writecapture79962456\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79962456", "widget\_prototype": "writecapture\_widget"}).