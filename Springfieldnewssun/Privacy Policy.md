marimo.emit('writecapture65941098\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture65941098", "widget\_prototype": "writecapture\_widget"}).