marimo.emit('writecapture76366800\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture76366800", "widget\_prototype": "writecapture\_widget"}).