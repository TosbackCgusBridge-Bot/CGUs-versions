marimo.emit('writecapture81727179\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture81727179", "widget\_prototype": "writecapture\_widget"}).