marimo.emit('writecapture75299985\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture75299985", "widget\_prototype": "writecapture\_widget"}).