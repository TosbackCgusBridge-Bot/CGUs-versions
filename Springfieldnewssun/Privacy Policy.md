marimo.emit('writecapture522049\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture522049", "widget\_prototype": "writecapture\_widget"}).