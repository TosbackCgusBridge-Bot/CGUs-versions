marimo.emit('writecapture10632583\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture10632583", "widget\_prototype": "writecapture\_widget"}).