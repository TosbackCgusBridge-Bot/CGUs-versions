marimo.emit('writecapture382544\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture382544", "widget\_prototype": "writecapture\_widget"}).