marimo.emit('writecapture14324461\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture14324461", "widget\_prototype": "writecapture\_widget"}).