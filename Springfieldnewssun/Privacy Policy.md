marimo.emit('writecapture23598232\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture23598232", "widget\_prototype": "writecapture\_widget"}).