marimo.emit('writecapture64079640\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64079640", "widget\_prototype": "writecapture\_widget"}).