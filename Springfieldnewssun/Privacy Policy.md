marimo.emit('writecapture64457719\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64457719", "widget\_prototype": "writecapture\_widget"}).