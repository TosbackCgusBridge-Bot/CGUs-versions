marimo.emit('writecapture64254576\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64254576", "widget\_prototype": "writecapture\_widget"}).