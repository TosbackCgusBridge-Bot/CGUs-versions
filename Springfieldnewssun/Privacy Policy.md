marimo.emit('writecapture17427915\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture17427915", "widget\_prototype": "writecapture\_widget"}).