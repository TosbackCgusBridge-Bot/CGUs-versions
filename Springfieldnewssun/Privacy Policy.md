marimo.emit('writecapture57256952\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture57256952", "widget\_prototype": "writecapture\_widget"}).