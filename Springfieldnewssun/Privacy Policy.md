marimo.emit('writecapture15074296\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture15074296", "widget\_prototype": "writecapture\_widget"}).