marimo.emit('writecapture74700342\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture74700342", "widget\_prototype": "writecapture\_widget"}).