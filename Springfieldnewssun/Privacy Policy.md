marimo.emit('writecapture7506826\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture7506826", "widget\_prototype": "writecapture\_widget"}).