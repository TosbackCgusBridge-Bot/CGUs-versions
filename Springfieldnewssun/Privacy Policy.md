marimo.emit('writecapture16361873\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16361873", "widget\_prototype": "writecapture\_widget"}).