marimo.emit('writecapture14884002\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture14884002", "widget\_prototype": "writecapture\_widget"}).