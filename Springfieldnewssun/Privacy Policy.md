marimo.emit('writecapture45757777\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture45757777", "widget\_prototype": "writecapture\_widget"}).