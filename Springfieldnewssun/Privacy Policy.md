marimo.emit('writecapture73957569\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture73957569", "widget\_prototype": "writecapture\_widget"}).