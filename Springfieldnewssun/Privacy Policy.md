marimo.emit('writecapture99304403\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99304403", "widget\_prototype": "writecapture\_widget"}).