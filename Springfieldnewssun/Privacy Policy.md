marimo.emit('writecapture92285922\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture92285922", "widget\_prototype": "writecapture\_widget"}).