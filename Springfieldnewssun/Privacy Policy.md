marimo.emit('writecapture49010887\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture49010887", "widget\_prototype": "writecapture\_widget"}).