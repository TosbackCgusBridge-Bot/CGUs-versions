marimo.emit('writecapture81829613\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture81829613", "widget\_prototype": "writecapture\_widget"}).