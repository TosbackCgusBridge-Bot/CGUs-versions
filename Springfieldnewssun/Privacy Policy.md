marimo.emit('writecapture65503741\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture65503741", "widget\_prototype": "writecapture\_widget"}).