marimo.emit('writecapture85193118\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture85193118", "widget\_prototype": "writecapture\_widget"}).