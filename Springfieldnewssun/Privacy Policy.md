marimo.emit('writecapture51169919\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture51169919", "widget\_prototype": "writecapture\_widget"}).