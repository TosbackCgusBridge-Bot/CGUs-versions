marimo.emit('writecapture41381811\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture41381811", "widget\_prototype": "writecapture\_widget"}).