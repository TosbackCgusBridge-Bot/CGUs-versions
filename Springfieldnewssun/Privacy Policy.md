marimo.emit('writecapture76091099\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture76091099", "widget\_prototype": "writecapture\_widget"}).