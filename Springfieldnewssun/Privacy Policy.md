marimo.emit('writecapture43187729\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture43187729", "widget\_prototype": "writecapture\_widget"}).