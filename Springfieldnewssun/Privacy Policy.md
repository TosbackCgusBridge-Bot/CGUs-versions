marimo.emit('writecapture72850941\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture72850941", "widget\_prototype": "writecapture\_widget"}).