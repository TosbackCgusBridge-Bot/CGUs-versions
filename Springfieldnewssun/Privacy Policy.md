marimo.emit('writecapture7255438\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7255438", "widget\_prototype": "writecapture\_widget"}).