marimo.emit('writecapture12691561\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture12691561", "widget\_prototype": "writecapture\_widget"}).