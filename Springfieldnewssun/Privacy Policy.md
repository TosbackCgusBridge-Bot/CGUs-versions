marimo.emit('writecapture3841146\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture3841146", "widget\_prototype": "writecapture\_widget"}).