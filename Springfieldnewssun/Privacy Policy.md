marimo.emit('writecapture75108665\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture75108665", "widget\_prototype": "writecapture\_widget"}).