marimo.emit('writecapture35335807\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35335807", "widget\_prototype": "writecapture\_widget"}).