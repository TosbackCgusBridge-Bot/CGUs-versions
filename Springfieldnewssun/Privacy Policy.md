marimo.emit('writecapture64863868\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64863868", "widget\_prototype": "writecapture\_widget"}).