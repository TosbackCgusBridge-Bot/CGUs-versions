marimo.emit('writecapture75340729\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture75340729", "widget\_prototype": "writecapture\_widget"}).