marimo.emit('writecapture54322678\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture54322678", "widget\_prototype": "writecapture\_widget"}).