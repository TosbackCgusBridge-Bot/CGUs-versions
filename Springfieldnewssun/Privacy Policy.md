marimo.emit('writecapture33991362\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture33991362", "widget\_prototype": "writecapture\_widget"}).