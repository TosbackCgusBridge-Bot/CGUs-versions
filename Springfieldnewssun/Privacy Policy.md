marimo.emit('writecapture79822992\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79822992", "widget\_prototype": "writecapture\_widget"}).