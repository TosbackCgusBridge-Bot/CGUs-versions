marimo.emit('writecapture80353873\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture80353873", "widget\_prototype": "writecapture\_widget"}).