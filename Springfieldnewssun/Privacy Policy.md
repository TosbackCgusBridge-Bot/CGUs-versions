marimo.emit('writecapture38205699\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture38205699", "widget\_prototype": "writecapture\_widget"}).