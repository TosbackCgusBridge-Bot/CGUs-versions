marimo.emit('writecapture55486057\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture55486057", "widget\_prototype": "writecapture\_widget"}).