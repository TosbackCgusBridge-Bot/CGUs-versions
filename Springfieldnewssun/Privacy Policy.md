marimo.emit('writecapture79890963\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79890963", "widget\_prototype": "writecapture\_widget"}).