marimo.emit('writecapture28612081\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28612081", "widget\_prototype": "writecapture\_widget"}).