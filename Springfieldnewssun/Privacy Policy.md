marimo.emit('writecapture90710814\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture90710814", "widget\_prototype": "writecapture\_widget"}).