marimo.emit('writecapture33073157\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture33073157", "widget\_prototype": "writecapture\_widget"}).