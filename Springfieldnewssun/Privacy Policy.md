marimo.emit('writecapture78650336\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78650336", "widget\_prototype": "writecapture\_widget"}).