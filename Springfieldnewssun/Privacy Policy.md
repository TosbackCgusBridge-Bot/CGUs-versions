marimo.emit('writecapture10074833\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture10074833", "widget\_prototype": "writecapture\_widget"}).