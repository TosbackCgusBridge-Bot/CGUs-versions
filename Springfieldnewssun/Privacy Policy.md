marimo.emit('writecapture63322122\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture63322122", "widget\_prototype": "writecapture\_widget"}).