marimo.emit('writecapture99582644\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99582644", "widget\_prototype": "writecapture\_widget"}).