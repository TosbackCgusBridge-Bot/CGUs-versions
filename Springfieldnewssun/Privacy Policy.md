marimo.emit('writecapture61979050\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture61979050", "widget\_prototype": "writecapture\_widget"}).