marimo.emit('writecapture89275290\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture89275290", "widget\_prototype": "writecapture\_widget"}).