marimo.emit('writecapture62105317\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture62105317", "widget\_prototype": "writecapture\_widget"}).