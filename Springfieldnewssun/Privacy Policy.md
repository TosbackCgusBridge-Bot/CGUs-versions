marimo.emit('writecapture25949811\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture25949811", "widget\_prototype": "writecapture\_widget"}).