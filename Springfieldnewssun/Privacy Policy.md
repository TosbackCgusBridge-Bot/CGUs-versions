marimo.emit('writecapture12255171\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture12255171", "widget\_prototype": "writecapture\_widget"}).