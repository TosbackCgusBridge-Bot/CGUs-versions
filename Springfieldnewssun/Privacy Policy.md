marimo.emit('writecapture62917440\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture62917440", "widget\_prototype": "writecapture\_widget"}).