marimo.emit('writecapture19722931\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19722931", "widget\_prototype": "writecapture\_widget"}).