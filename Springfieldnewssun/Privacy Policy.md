marimo.emit('writecapture20431001\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20431001", "widget\_prototype": "writecapture\_widget"}).