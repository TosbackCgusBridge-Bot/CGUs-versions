marimo.emit('writecapture42312556\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42312556", "widget\_prototype": "writecapture\_widget"}).