marimo.emit('writecapture28844715\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28844715", "widget\_prototype": "writecapture\_widget"}).