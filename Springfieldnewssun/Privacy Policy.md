marimo.emit('writecapture78873565\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78873565", "widget\_prototype": "writecapture\_widget"}).