marimo.emit('writecapture92664079\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture92664079", "widget\_prototype": "writecapture\_widget"}).