marimo.emit('writecapture25382924\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture25382924", "widget\_prototype": "writecapture\_widget"}).