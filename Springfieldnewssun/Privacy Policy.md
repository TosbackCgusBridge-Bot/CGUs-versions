marimo.emit('writecapture19646491\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19646491", "widget\_prototype": "writecapture\_widget"}).