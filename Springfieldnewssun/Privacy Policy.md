marimo.emit('writecapture42236084\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42236084", "widget\_prototype": "writecapture\_widget"}).