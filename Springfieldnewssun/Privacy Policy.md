marimo.emit('writecapture30346986\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture30346986", "widget\_prototype": "writecapture\_widget"}).