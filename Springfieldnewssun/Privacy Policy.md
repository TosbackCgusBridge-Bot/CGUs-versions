marimo.emit('writecapture85324522\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture85324522", "widget\_prototype": "writecapture\_widget"}).