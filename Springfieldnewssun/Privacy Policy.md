marimo.emit('writecapture45172301\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture45172301", "widget\_prototype": "writecapture\_widget"}).