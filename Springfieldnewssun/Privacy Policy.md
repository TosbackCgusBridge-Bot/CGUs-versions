marimo.emit('writecapture19355118\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19355118", "widget\_prototype": "writecapture\_widget"}).