marimo.emit('writecapture34721302\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture34721302", "widget\_prototype": "writecapture\_widget"}).