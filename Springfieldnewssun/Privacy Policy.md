marimo.emit('writecapture28022597\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28022597", "widget\_prototype": "writecapture\_widget"}).