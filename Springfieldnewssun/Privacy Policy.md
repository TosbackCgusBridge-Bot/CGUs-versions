marimo.emit('writecapture15338230\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture15338230", "widget\_prototype": "writecapture\_widget"}).