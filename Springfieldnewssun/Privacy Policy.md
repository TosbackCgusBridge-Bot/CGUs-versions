marimo.emit('writecapture91019052\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture91019052", "widget\_prototype": "writecapture\_widget"}).