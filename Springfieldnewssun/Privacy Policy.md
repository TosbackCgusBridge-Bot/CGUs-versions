marimo.emit('writecapture24252494\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture24252494", "widget\_prototype": "writecapture\_widget"}).