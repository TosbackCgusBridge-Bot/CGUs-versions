marimo.emit('writecapture50784311\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture50784311", "widget\_prototype": "writecapture\_widget"}).