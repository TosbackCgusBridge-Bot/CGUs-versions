marimo.emit('writecapture42754320\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42754320", "widget\_prototype": "writecapture\_widget"}).