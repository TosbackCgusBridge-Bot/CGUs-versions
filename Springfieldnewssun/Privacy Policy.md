marimo.emit('writecapture63350495\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture63350495", "widget\_prototype": "writecapture\_widget"}).