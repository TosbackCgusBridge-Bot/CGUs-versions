marimo.emit('writecapture85913496\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture85913496", "widget\_prototype": "writecapture\_widget"}).