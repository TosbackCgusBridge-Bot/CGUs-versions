marimo.emit('writecapture20181234\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20181234", "widget\_prototype": "writecapture\_widget"}).