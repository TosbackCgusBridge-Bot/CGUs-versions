marimo.emit('writecapture59835344\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59835344", "widget\_prototype": "writecapture\_widget"}).