marimo.emit('writecapture52854612\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture52854612", "widget\_prototype": "writecapture\_widget"}).