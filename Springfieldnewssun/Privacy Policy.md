marimo.emit('writecapture2731372\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture2731372", "widget\_prototype": "writecapture\_widget"}).