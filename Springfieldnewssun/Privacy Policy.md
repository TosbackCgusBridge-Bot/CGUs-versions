marimo.emit('writecapture99411403\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99411403", "widget\_prototype": "writecapture\_widget"}).