marimo.emit('writecapture90780153\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture90780153", "widget\_prototype": "writecapture\_widget"}).