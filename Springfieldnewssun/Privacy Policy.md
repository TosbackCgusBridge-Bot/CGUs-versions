marimo.emit('writecapture40483104\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture40483104", "widget\_prototype": "writecapture\_widget"}).