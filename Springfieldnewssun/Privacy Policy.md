marimo.emit('writecapture97887712\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture97887712", "widget\_prototype": "writecapture\_widget"}).