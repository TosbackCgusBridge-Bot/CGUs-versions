marimo.emit('writecapture32408745\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture32408745", "widget\_prototype": "writecapture\_widget"}).