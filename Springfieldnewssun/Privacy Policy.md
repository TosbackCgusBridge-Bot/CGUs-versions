marimo.emit('writecapture63201392\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture63201392", "widget\_prototype": "writecapture\_widget"}).