marimo.emit('writecapture59724883\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59724883", "widget\_prototype": "writecapture\_widget"}).