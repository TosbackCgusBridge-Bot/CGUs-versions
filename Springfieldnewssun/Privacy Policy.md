marimo.emit('writecapture12590492\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture12590492", "widget\_prototype": "writecapture\_widget"}).