marimo.emit('writecapture47971018\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture47971018", "widget\_prototype": "writecapture\_widget"}).