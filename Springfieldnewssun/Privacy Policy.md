marimo.emit('writecapture96608848\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture96608848", "widget\_prototype": "writecapture\_widget"}).