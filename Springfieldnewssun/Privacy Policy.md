marimo.emit('writecapture17911826\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture17911826", "widget\_prototype": "writecapture\_widget"}).