marimo.emit('writecapture41643520\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture41643520", "widget\_prototype": "writecapture\_widget"}).