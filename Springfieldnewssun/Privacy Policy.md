marimo.emit('writecapture32195353\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture32195353", "widget\_prototype": "writecapture\_widget"}).