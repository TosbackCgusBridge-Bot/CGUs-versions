marimo.emit('writecapture4186942\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture4186942", "widget\_prototype": "writecapture\_widget"}).