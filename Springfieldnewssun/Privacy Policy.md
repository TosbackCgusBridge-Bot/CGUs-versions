marimo.emit('writecapture41015260\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture41015260", "widget\_prototype": "writecapture\_widget"}).