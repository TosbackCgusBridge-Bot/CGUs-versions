marimo.emit('writecapture69713903\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture69713903", "widget\_prototype": "writecapture\_widget"}).