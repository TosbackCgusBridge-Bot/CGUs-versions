marimo.emit('writecapture99229295\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99229295", "widget\_prototype": "writecapture\_widget"}).