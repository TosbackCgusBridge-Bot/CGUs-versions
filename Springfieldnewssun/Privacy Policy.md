marimo.emit('writecapture68903826\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture68903826", "widget\_prototype": "writecapture\_widget"}).