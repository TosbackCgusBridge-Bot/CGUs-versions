marimo.emit('writecapture78594086\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78594086", "widget\_prototype": "writecapture\_widget"}).