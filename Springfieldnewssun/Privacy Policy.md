marimo.emit('writecapture86209231\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture86209231", "widget\_prototype": "writecapture\_widget"}).