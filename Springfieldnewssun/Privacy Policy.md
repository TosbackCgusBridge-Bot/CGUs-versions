marimo.emit('writecapture60605128\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture60605128", "widget\_prototype": "writecapture\_widget"}).