marimo.emit('writecapture97699670\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture97699670", "widget\_prototype": "writecapture\_widget"}).