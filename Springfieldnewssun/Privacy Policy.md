marimo.emit('writecapture57753079\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture57753079", "widget\_prototype": "writecapture\_widget"}).