marimo.emit('writecapture60228402\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture60228402", "widget\_prototype": "writecapture\_widget"}).