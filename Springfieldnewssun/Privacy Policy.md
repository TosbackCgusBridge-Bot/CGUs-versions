marimo.emit('writecapture37812758\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture37812758", "widget\_prototype": "writecapture\_widget"}).