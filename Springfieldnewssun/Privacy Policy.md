marimo.emit('writecapture36268149\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture36268149", "widget\_prototype": "writecapture\_widget"}).