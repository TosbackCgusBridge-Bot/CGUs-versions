marimo.emit('writecapture13527789\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture13527789", "widget\_prototype": "writecapture\_widget"}).