marimo.emit('writecapture15330949\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture15330949", "widget\_prototype": "writecapture\_widget"}).