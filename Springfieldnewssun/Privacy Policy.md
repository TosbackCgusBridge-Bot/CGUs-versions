marimo.emit('writecapture59488985\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59488985", "widget\_prototype": "writecapture\_widget"}).