marimo.emit('writecapture48617509\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture48617509", "widget\_prototype": "writecapture\_widget"}).