marimo.emit('writecapture23003936\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture23003936", "widget\_prototype": "writecapture\_widget"}).