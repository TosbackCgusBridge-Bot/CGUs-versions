marimo.emit('writecapture19587392\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19587392", "widget\_prototype": "writecapture\_widget"}).