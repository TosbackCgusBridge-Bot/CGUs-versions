marimo.emit('writecapture10243476\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture10243476", "widget\_prototype": "writecapture\_widget"}).