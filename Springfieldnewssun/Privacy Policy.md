marimo.emit('writecapture20777516\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20777516", "widget\_prototype": "writecapture\_widget"}).