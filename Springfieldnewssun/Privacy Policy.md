marimo.emit('writecapture47829297\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture47829297", "widget\_prototype": "writecapture\_widget"}).