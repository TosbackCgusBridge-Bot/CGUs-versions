marimo.emit('writecapture27976695\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture27976695", "widget\_prototype": "writecapture\_widget"}).