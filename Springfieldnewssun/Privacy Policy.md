marimo.emit('writecapture33185928\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture33185928", "widget\_prototype": "writecapture\_widget"}).