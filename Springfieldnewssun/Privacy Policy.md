marimo.emit('writecapture8833511\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture8833511", "widget\_prototype": "writecapture\_widget"}).