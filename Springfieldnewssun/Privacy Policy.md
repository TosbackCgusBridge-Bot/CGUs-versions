marimo.emit('writecapture9539081\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture9539081", "widget\_prototype": "writecapture\_widget"}).