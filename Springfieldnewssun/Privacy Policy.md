marimo.emit('writecapture23421556\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture23421556", "widget\_prototype": "writecapture\_widget"}).