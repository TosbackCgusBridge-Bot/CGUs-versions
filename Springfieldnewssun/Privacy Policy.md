marimo.emit('writecapture38761053\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture38761053", "widget\_prototype": "writecapture\_widget"}).