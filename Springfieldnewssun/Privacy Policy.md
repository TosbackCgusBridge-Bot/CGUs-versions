marimo.emit('writecapture21061713\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture21061713", "widget\_prototype": "writecapture\_widget"}).