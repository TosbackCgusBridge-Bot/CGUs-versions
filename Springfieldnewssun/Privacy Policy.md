marimo.emit('writecapture55922589\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture55922589", "widget\_prototype": "writecapture\_widget"}).