marimo.emit('writecapture88187215\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture88187215", "widget\_prototype": "writecapture\_widget"}).