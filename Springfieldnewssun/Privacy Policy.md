marimo.emit('writecapture43198222\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture43198222", "widget\_prototype": "writecapture\_widget"}).