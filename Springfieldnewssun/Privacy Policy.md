marimo.emit('writecapture30849152\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture30849152", "widget\_prototype": "writecapture\_widget"}).