marimo.emit('writecapture65398063\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture65398063", "widget\_prototype": "writecapture\_widget"}).