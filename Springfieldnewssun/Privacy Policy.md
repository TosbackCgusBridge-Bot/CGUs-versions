marimo.emit('writecapture73685683\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture73685683", "widget\_prototype": "writecapture\_widget"}).