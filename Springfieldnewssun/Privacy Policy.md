marimo.emit('writecapture71579913\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture71579913", "widget\_prototype": "writecapture\_widget"}).