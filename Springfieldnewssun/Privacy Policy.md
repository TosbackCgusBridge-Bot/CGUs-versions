marimo.emit('writecapture94559453\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture94559453", "widget\_prototype": "writecapture\_widget"}).