marimo.emit('writecapture41532283\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture41532283", "widget\_prototype": "writecapture\_widget"}).