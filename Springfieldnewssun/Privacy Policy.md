marimo.emit('writecapture59734597\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59734597", "widget\_prototype": "writecapture\_widget"}).