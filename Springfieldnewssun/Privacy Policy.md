marimo.emit('writecapture16928661\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16928661", "widget\_prototype": "writecapture\_widget"}).