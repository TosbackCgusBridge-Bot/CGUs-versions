marimo.emit('writecapture40081647\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE Privacy Policy$NEWLINE
...
$NEWLINE ", "id": "writecapture40081647", "widget\_prototype": "writecapture\_widget"}).