marimo.emit('writecapture32447820\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture32447820", "widget\_prototype": "writecapture\_widget"}).