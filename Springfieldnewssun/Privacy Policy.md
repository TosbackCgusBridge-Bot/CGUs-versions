marimo.emit('writecapture42511002\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42511002", "widget\_prototype": "writecapture\_widget"}).