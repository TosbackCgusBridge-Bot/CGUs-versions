marimo.emit('writecapture71366006\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture71366006", "widget\_prototype": "writecapture\_widget"}).