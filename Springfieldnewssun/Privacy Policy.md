marimo.emit('writecapture56166612\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture56166612", "widget\_prototype": "writecapture\_widget"}).