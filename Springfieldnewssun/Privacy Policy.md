marimo.emit('writecapture46649591\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture46649591", "widget\_prototype": "writecapture\_widget"}).