marimo.emit('writecapture16608406\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16608406", "widget\_prototype": "writecapture\_widget"}).