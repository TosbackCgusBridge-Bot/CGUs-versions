marimo.emit('writecapture8319496\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture8319496", "widget\_prototype": "writecapture\_widget"}).