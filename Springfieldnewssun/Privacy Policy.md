marimo.emit('writecapture38864401\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture38864401", "widget\_prototype": "writecapture\_widget"}).