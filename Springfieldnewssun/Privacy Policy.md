marimo.emit('writecapture59502990\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59502990", "widget\_prototype": "writecapture\_widget"}).