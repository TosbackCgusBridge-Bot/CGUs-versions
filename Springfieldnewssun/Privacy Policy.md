marimo.emit('writecapture90851917\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture90851917", "widget\_prototype": "writecapture\_widget"}).