marimo.emit('writecapture77411401\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE Privacy Policy$NEWLINE
...
$NEWLINE ", "id": "writecapture77411401", "widget\_prototype": "writecapture\_widget"}).