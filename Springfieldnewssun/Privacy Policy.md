marimo.emit('writecapture53645857\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture53645857", "widget\_prototype": "writecapture\_widget"}).