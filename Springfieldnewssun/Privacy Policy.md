marimo.emit('writecapture59784456\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE Privacy Policy$NEWLINE
...
$NEWLINE ", "id": "writecapture59784456", "widget\_prototype": "writecapture\_widget"}).