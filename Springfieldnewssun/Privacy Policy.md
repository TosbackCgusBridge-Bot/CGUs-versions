marimo.emit('writecapture31042412\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture31042412", "widget\_prototype": "writecapture\_widget"}).