marimo.emit('writecapture63532393\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture63532393", "widget\_prototype": "writecapture\_widget"}).