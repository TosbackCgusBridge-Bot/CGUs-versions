marimo.emit('writecapture97954855\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture97954855", "widget\_prototype": "writecapture\_widget"}).