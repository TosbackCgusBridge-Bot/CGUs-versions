marimo.emit('writecapture19445764\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19445764", "widget\_prototype": "writecapture\_widget"}).