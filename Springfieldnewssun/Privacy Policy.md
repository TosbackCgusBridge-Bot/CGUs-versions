marimo.emit('writecapture81325434\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture81325434", "widget\_prototype": "writecapture\_widget"}).