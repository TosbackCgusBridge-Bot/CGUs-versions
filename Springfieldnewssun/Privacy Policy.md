marimo.emit('writecapture8002225\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture8002225", "widget\_prototype": "writecapture\_widget"}).