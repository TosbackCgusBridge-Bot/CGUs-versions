marimo.emit('writecapture88467113\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture88467113", "widget\_prototype": "writecapture\_widget"}).