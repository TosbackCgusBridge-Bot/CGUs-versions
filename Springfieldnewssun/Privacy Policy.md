marimo.emit('writecapture9962140\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture9962140", "widget\_prototype": "writecapture\_widget"}).