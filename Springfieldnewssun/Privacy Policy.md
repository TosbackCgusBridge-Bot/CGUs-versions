marimo.emit('writecapture39768730\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39768730", "widget\_prototype": "writecapture\_widget"}).