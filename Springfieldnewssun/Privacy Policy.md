marimo.emit('writecapture73462166\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture73462166", "widget\_prototype": "writecapture\_widget"}).