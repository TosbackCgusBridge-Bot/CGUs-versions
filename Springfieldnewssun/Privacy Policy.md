marimo.emit('writecapture78093735\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78093735", "widget\_prototype": "writecapture\_widget"}).