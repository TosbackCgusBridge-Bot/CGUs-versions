marimo.emit('writecapture21144502\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture21144502", "widget\_prototype": "writecapture\_widget"}).