marimo.emit('writecapture20262846\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20262846", "widget\_prototype": "writecapture\_widget"}).