marimo.emit('writecapture35781221\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35781221", "widget\_prototype": "writecapture\_widget"}).