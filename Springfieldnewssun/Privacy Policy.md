marimo.emit('writecapture82751985\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture82751985", "widget\_prototype": "writecapture\_widget"}).