marimo.emit('writecapture7180747\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7180747", "widget\_prototype": "writecapture\_widget"}).