marimo.emit('writecapture68978022\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture68978022", "widget\_prototype": "writecapture\_widget"}).