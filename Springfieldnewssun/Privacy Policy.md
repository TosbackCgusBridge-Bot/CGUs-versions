marimo.emit('writecapture36885178\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture36885178", "widget\_prototype": "writecapture\_widget"}).