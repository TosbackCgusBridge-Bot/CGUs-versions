marimo.emit('writecapture676791\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture676791", "widget\_prototype": "writecapture\_widget"}).