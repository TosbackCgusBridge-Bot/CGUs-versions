marimo.emit('writecapture20438886\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20438886", "widget\_prototype": "writecapture\_widget"}).