marimo.emit('writecapture61682618\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture61682618", "widget\_prototype": "writecapture\_widget"}).