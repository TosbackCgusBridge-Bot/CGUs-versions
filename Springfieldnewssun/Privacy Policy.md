marimo.emit('writecapture32962884\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture32962884", "widget\_prototype": "writecapture\_widget"}).