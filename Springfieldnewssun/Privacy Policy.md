marimo.emit('writecapture52891391\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture52891391", "widget\_prototype": "writecapture\_widget"}).