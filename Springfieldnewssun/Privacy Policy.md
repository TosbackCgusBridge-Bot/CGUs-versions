marimo.emit('writecapture19425181\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19425181", "widget\_prototype": "writecapture\_widget"}).