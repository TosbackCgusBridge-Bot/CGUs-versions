marimo.emit('writecapture77255287\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture77255287", "widget\_prototype": "writecapture\_widget"}).