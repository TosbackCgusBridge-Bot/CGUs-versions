marimo.emit('writecapture35271766\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35271766", "widget\_prototype": "writecapture\_widget"}).