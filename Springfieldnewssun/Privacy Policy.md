marimo.emit('writecapture92177014\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture92177014", "widget\_prototype": "writecapture\_widget"}).