marimo.emit('writecapture40549701\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture40549701", "widget\_prototype": "writecapture\_widget"}).