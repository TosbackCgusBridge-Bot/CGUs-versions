marimo.emit('writecapture74549935\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture74549935", "widget\_prototype": "writecapture\_widget"}).