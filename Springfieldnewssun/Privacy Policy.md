marimo.emit('writecapture9748628\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture9748628", "widget\_prototype": "writecapture\_widget"}).