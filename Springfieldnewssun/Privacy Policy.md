marimo.emit('writecapture10184139\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture10184139", "widget\_prototype": "writecapture\_widget"}).