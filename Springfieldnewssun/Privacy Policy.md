marimo.emit('writecapture11988400\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11988400", "widget\_prototype": "writecapture\_widget"}).