marimo.emit('writecapture64838359\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64838359", "widget\_prototype": "writecapture\_widget"}).