marimo.emit('writecapture56230082\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture56230082", "widget\_prototype": "writecapture\_widget"}).