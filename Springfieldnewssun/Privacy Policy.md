marimo.emit('writecapture28649446\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture28649446", "widget\_prototype": "writecapture\_widget"}).