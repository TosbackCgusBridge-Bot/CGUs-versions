marimo.emit('writecapture3014499\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture3014499", "widget\_prototype": "writecapture\_widget"}).