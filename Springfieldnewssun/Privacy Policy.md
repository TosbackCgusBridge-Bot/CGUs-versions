marimo.emit('writecapture54749446\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture54749446", "widget\_prototype": "writecapture\_widget"}).