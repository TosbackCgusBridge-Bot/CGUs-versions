marimo.emit('writecapture31466726\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture31466726", "widget\_prototype": "writecapture\_widget"}).