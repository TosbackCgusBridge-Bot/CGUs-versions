marimo.emit('writecapture26488281\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture26488281", "widget\_prototype": "writecapture\_widget"}).