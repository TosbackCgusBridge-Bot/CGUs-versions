marimo.emit('writecapture3828824\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture3828824", "widget\_prototype": "writecapture\_widget"}).