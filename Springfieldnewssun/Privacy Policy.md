marimo.emit('writecapture75594152\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture75594152", "widget\_prototype": "writecapture\_widget"}).