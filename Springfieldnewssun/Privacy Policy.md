marimo.emit('writecapture6623857\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6623857", "widget\_prototype": "writecapture\_widget"}).