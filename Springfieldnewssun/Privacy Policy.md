marimo.emit('writecapture35570691\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35570691", "widget\_prototype": "writecapture\_widget"}).