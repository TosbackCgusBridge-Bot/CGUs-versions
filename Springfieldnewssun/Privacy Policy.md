marimo.emit('writecapture24188911\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture24188911", "widget\_prototype": "writecapture\_widget"}).