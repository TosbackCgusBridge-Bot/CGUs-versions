marimo.emit('writecapture64542279\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64542279", "widget\_prototype": "writecapture\_widget"}).