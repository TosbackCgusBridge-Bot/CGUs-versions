marimo.emit('writecapture32358497\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture32358497", "widget\_prototype": "writecapture\_widget"}).