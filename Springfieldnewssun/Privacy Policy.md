marimo.emit('writecapture7183576\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7183576", "widget\_prototype": "writecapture\_widget"}).