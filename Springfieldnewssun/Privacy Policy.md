marimo.emit('writecapture80702147\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture80702147", "widget\_prototype": "writecapture\_widget"}).