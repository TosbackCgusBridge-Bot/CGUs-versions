marimo.emit('writecapture37673676\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture37673676", "widget\_prototype": "writecapture\_widget"}).