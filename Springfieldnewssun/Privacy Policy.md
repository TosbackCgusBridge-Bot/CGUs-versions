marimo.emit('writecapture98214858\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture98214858", "widget\_prototype": "writecapture\_widget"}).