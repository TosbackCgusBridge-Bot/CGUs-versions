marimo.emit('writecapture531493\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture531493", "widget\_prototype": "writecapture\_widget"}).