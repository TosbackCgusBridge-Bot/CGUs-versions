marimo.emit('writecapture56415908\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture56415908", "widget\_prototype": "writecapture\_widget"}).