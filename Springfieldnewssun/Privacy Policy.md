marimo.emit('writecapture59902346\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59902346", "widget\_prototype": "writecapture\_widget"}).