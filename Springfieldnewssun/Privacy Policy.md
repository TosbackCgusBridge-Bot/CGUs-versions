marimo.emit('writecapture68589641\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture68589641", "widget\_prototype": "writecapture\_widget"}).