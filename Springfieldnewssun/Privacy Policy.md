marimo.emit('writecapture27771841\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture27771841", "widget\_prototype": "writecapture\_widget"}).