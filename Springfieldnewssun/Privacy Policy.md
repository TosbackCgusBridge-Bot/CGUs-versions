marimo.emit('writecapture32307266\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture32307266", "widget\_prototype": "writecapture\_widget"}).