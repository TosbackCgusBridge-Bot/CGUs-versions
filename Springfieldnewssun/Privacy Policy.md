marimo.emit('writecapture16869674\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16869674", "widget\_prototype": "writecapture\_widget"}).