marimo.emit('writecapture58651037\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture58651037", "widget\_prototype": "writecapture\_widget"}).