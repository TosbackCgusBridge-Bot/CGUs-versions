marimo.emit('writecapture54630354\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture54630354", "widget\_prototype": "writecapture\_widget"}).