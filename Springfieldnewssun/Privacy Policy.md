marimo.emit('writecapture73176888\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture73176888", "widget\_prototype": "writecapture\_widget"}).