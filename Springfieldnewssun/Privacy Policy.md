marimo.emit('writecapture74312904\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture74312904", "widget\_prototype": "writecapture\_widget"}).