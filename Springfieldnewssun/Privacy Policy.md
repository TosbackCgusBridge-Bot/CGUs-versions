marimo.emit('writecapture1110031\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture1110031", "widget\_prototype": "writecapture\_widget"}).