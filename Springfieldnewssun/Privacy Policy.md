marimo.emit('writecapture86244805\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture86244805", "widget\_prototype": "writecapture\_widget"}).