marimo.emit('writecapture6781909\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6781909", "widget\_prototype": "writecapture\_widget"}).