marimo.emit('writecapture79035301\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79035301", "widget\_prototype": "writecapture\_widget"}).