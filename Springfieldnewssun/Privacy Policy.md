marimo.emit('writecapture20284824\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture20284824", "widget\_prototype": "writecapture\_widget"}).