marimo.emit('writecapture61714921\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture61714921", "widget\_prototype": "writecapture\_widget"}).