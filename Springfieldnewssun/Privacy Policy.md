marimo.emit('writecapture60923758\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture60923758", "widget\_prototype": "writecapture\_widget"}).