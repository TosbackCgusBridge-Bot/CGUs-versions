marimo.emit('writecapture35612946\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35612946", "widget\_prototype": "writecapture\_widget"}).