marimo.emit('writecapture59417576\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59417576", "widget\_prototype": "writecapture\_widget"}).