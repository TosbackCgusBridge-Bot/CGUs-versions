marimo.emit('writecapture93009876\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture93009876", "widget\_prototype": "writecapture\_widget"}).