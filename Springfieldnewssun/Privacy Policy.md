marimo.emit('writecapture89102588\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture89102588", "widget\_prototype": "writecapture\_widget"}).