marimo.emit('writecapture99623742\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99623742", "widget\_prototype": "writecapture\_widget"}).