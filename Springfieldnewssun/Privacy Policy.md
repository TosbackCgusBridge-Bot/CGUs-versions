marimo.emit('writecapture38164654\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture38164654", "widget\_prototype": "writecapture\_widget"}).