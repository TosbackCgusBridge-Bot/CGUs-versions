marimo.emit('writecapture16134605\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16134605", "widget\_prototype": "writecapture\_widget"}).