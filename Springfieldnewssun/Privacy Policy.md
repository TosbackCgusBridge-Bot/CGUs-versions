marimo.emit('writecapture52223815\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture52223815", "widget\_prototype": "writecapture\_widget"}).