marimo.emit('writecapture96845334\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture96845334", "widget\_prototype": "writecapture\_widget"}).