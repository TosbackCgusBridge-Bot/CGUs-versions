marimo.emit('writecapture4426284\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture4426284", "widget\_prototype": "writecapture\_widget"}).