marimo.emit('writecapture3110514\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture3110514", "widget\_prototype": "writecapture\_widget"}).