marimo.emit('writecapture46700644\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture46700644", "widget\_prototype": "writecapture\_widget"}).