marimo.emit('writecapture51903160\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture51903160", "widget\_prototype": "writecapture\_widget"}).