marimo.emit('writecapture8891100\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture8891100", "widget\_prototype": "writecapture\_widget"}).