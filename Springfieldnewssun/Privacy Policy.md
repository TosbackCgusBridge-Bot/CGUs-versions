marimo.emit('writecapture79532992\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture79532992", "widget\_prototype": "writecapture\_widget"}).