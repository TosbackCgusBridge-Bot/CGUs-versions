marimo.emit('writecapture46433470\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture46433470", "widget\_prototype": "writecapture\_widget"}).