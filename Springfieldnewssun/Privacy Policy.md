marimo.emit('writecapture14979580\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture14979580", "widget\_prototype": "writecapture\_widget"}).