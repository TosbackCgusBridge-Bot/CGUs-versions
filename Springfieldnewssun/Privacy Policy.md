marimo.emit('writecapture86506165\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture86506165", "widget\_prototype": "writecapture\_widget"}).