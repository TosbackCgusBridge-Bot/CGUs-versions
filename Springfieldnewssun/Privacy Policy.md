marimo.emit('writecapture42364964\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42364964", "widget\_prototype": "writecapture\_widget"}).