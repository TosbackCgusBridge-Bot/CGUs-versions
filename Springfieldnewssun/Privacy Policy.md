marimo.emit('writecapture94600344\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture94600344", "widget\_prototype": "writecapture\_widget"}).