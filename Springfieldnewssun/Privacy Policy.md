marimo.emit('writecapture39033231\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39033231", "widget\_prototype": "writecapture\_widget"}).