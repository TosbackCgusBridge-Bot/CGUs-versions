marimo.emit('writecapture57770621\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture57770621", "widget\_prototype": "writecapture\_widget"}).