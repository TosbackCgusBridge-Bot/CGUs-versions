marimo.emit('writecapture16010894\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE
...
$NEWLINE ", "id": "writecapture16010894", "widget\_prototype": "writecapture\_widget"}).