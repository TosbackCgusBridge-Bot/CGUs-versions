marimo.emit('writecapture90375880\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture90375880", "widget\_prototype": "writecapture\_widget"}).