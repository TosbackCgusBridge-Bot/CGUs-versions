marimo.emit('writecapture63181305\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture63181305", "widget\_prototype": "writecapture\_widget"}).