marimo.emit('writecapture47515386\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture47515386", "widget\_prototype": "writecapture\_widget"}).