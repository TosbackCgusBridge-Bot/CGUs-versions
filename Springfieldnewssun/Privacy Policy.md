marimo.emit('writecapture2088431\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture2088431", "widget\_prototype": "writecapture\_widget"}).