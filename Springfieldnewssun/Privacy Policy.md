marimo.emit('writecapture73807272\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture73807272", "widget\_prototype": "writecapture\_widget"}).