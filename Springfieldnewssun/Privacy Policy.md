marimo.emit('writecapture86958483\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture86958483", "widget\_prototype": "writecapture\_widget"}).