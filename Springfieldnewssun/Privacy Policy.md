marimo.emit('writecapture52561336\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture52561336", "widget\_prototype": "writecapture\_widget"}).