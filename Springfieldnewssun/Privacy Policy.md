marimo.emit('writecapture94442803\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture94442803", "widget\_prototype": "writecapture\_widget"}).