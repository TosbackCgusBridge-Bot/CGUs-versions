marimo.emit('writecapture53061202\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture53061202", "widget\_prototype": "writecapture\_widget"}).