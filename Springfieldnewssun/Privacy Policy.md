marimo.emit('writecapture50753973\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture50753973", "widget\_prototype": "writecapture\_widget"}).