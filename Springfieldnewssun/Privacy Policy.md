marimo.emit('writecapture53270032\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture53270032", "widget\_prototype": "writecapture\_widget"}).