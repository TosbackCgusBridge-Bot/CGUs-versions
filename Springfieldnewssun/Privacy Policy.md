marimo.emit('writecapture78049022\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78049022", "widget\_prototype": "writecapture\_widget"}).