marimo.emit('writecapture2443219\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture2443219", "widget\_prototype": "writecapture\_widget"}).