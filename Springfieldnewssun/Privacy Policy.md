marimo.emit('writecapture87593665\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture87593665", "widget\_prototype": "writecapture\_widget"}).