marimo.emit('writecapture57165964\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture57165964", "widget\_prototype": "writecapture\_widget"}).