marimo.emit('writecapture2693\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture2693", "widget\_prototype": "writecapture\_widget"}).