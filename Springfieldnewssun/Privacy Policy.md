marimo.emit('writecapture98550194\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture98550194", "widget\_prototype": "writecapture\_widget"}).