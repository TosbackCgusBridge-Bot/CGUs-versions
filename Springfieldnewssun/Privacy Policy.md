marimo.emit('writecapture39329292\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture39329292", "widget\_prototype": "writecapture\_widget"}).