marimo.emit('writecapture94687719\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture94687719", "widget\_prototype": "writecapture\_widget"}).