marimo.emit('writecapture63972247\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture63972247", "widget\_prototype": "writecapture\_widget"}).