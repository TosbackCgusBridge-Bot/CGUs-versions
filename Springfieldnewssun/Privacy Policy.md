marimo.emit('writecapture80648898\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture80648898", "widget\_prototype": "writecapture\_widget"}).