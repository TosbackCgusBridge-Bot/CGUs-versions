marimo.emit('writecapture14504822\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture14504822", "widget\_prototype": "writecapture\_widget"}).