marimo.emit('writecapture26659069\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture26659069", "widget\_prototype": "writecapture\_widget"}).