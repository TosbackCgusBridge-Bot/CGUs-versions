marimo.emit('writecapture56572109\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture56572109", "widget\_prototype": "writecapture\_widget"}).