marimo.emit('writecapture74868089\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture74868089", "widget\_prototype": "writecapture\_widget"}).