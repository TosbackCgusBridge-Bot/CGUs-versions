marimo.emit('writecapture29087918\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture29087918", "widget\_prototype": "writecapture\_widget"}).