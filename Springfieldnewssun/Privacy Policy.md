marimo.emit('writecapture22495865\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture22495865", "widget\_prototype": "writecapture\_widget"}).