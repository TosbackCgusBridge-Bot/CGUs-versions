marimo.emit('writecapture16457238\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16457238", "widget\_prototype": "writecapture\_widget"}).