marimo.emit('writecapture38828851\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture38828851", "widget\_prototype": "writecapture\_widget"}).