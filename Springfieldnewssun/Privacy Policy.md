marimo.emit('writecapture69574019\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture69574019", "widget\_prototype": "writecapture\_widget"}).