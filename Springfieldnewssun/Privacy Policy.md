marimo.emit('writecapture17052018\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture17052018", "widget\_prototype": "writecapture\_widget"}).