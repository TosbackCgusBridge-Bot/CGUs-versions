marimo.emit('writecapture78718576\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78718576", "widget\_prototype": "writecapture\_widget"}).