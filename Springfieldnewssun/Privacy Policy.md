marimo.emit('writecapture66532869\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture66532869", "widget\_prototype": "writecapture\_widget"}).