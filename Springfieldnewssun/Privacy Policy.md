marimo.emit('writecapture13263955\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture13263955", "widget\_prototype": "writecapture\_widget"}).