marimo.emit('writecapture55551548\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture55551548", "widget\_prototype": "writecapture\_widget"}).