marimo.emit('writecapture86186263\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE Privacy Policy$NEWLINE
...
$NEWLINE ", "id": "writecapture86186263", "widget\_prototype": "writecapture\_widget"}).