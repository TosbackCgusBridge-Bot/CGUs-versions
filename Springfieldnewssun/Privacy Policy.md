marimo.emit('writecapture80602375\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture80602375", "widget\_prototype": "writecapture\_widget"}).