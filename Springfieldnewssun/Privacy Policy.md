marimo.emit('writecapture84395919\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture84395919", "widget\_prototype": "writecapture\_widget"}).