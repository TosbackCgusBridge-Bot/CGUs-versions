marimo.emit('writecapture25785845\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture25785845", "widget\_prototype": "writecapture\_widget"}).