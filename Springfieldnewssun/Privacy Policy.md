marimo.emit('writecapture22420315\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture22420315", "widget\_prototype": "writecapture\_widget"}).