marimo.emit('writecapture74694308\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture74694308", "widget\_prototype": "writecapture\_widget"}).