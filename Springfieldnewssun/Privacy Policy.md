marimo.emit('writecapture69947375\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture69947375", "widget\_prototype": "writecapture\_widget"}).