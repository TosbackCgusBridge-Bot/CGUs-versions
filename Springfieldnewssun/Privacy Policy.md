marimo.emit('writecapture9292466\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture9292466", "widget\_prototype": "writecapture\_widget"}).