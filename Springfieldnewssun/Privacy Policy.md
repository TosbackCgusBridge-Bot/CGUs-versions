marimo.emit('writecapture70773924\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture70773924", "widget\_prototype": "writecapture\_widget"}).