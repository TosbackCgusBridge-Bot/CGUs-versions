marimo.emit('writecapture64789195\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64789195", "widget\_prototype": "writecapture\_widget"}).