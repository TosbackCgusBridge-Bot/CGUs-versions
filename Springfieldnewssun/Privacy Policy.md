marimo.emit('writecapture19512167\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19512167", "widget\_prototype": "writecapture\_widget"}).