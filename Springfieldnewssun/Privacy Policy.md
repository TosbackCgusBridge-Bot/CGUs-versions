marimo.emit('writecapture16145008\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16145008", "widget\_prototype": "writecapture\_widget"}).