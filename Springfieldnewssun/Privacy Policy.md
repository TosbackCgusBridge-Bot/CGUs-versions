marimo.emit('writecapture35843014\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture35843014", "widget\_prototype": "writecapture\_widget"}).