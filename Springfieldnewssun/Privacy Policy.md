marimo.emit('writecapture60722315\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture60722315", "widget\_prototype": "writecapture\_widget"}).