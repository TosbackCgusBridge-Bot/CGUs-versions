marimo.emit('writecapture7632171\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture7632171", "widget\_prototype": "writecapture\_widget"}).