marimo.emit('writecapture60220648\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture60220648", "widget\_prototype": "writecapture\_widget"}).