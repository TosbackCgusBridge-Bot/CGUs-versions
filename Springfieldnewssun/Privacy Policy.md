marimo.emit('writecapture4495240\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture4495240", "widget\_prototype": "writecapture\_widget"}).