marimo.emit('writecapture25254077\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture25254077", "widget\_prototype": "writecapture\_widget"}).