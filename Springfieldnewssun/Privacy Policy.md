marimo.emit('writecapture26368131\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture26368131", "widget\_prototype": "writecapture\_widget"}).