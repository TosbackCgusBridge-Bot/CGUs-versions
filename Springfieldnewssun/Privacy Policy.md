marimo.emit('writecapture69065558\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture69065558", "widget\_prototype": "writecapture\_widget"}).