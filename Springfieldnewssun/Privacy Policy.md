marimo.emit('writecapture50931584\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture50931584", "widget\_prototype": "writecapture\_widget"}).