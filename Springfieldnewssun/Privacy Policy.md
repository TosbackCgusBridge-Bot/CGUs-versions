marimo.emit('writecapture88021688\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture88021688", "widget\_prototype": "writecapture\_widget"}).