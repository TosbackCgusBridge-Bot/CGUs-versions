marimo.emit('writecapture6381658\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture6381658", "widget\_prototype": "writecapture\_widget"}).