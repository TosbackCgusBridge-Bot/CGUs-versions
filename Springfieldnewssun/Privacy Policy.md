marimo.emit('writecapture64824241\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64824241", "widget\_prototype": "writecapture\_widget"}).