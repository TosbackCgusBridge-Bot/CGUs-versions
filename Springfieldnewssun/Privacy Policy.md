marimo.emit('writecapture22093608\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture22093608", "widget\_prototype": "writecapture\_widget"}).