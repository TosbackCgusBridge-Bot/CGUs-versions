marimo.emit('writecapture66941730\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture66941730", "widget\_prototype": "writecapture\_widget"}).