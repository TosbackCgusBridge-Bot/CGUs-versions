marimo.emit('writecapture87250067\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture87250067", "widget\_prototype": "writecapture\_widget"}).