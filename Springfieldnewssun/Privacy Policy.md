marimo.emit('writecapture76979326\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture76979326", "widget\_prototype": "writecapture\_widget"}).