marimo.emit('writecapture42470076\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42470076", "widget\_prototype": "writecapture\_widget"}).