marimo.emit('writecapture42755240\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture42755240", "widget\_prototype": "writecapture\_widget"}).