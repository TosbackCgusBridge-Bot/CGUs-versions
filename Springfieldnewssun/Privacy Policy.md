marimo.emit('writecapture81418736\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture81418736", "widget\_prototype": "writecapture\_widget"}).