marimo.emit('writecapture19986815\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture19986815", "widget\_prototype": "writecapture\_widget"}).