marimo.emit('writecapture26449881\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture26449881", "widget\_prototype": "writecapture\_widget"}).