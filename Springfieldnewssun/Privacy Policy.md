marimo.emit('writecapture64951593\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture64951593", "widget\_prototype": "writecapture\_widget"}).