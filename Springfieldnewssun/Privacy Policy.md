marimo.emit('writecapture47372048\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture47372048", "widget\_prototype": "writecapture\_widget"}).