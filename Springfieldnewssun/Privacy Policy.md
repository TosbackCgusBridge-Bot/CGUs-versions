marimo.emit('writecapture27019770\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture27019770", "widget\_prototype": "writecapture\_widget"}).