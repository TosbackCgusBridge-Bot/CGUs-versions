marimo.emit('writecapture89442211\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture89442211", "widget\_prototype": "writecapture\_widget"}).