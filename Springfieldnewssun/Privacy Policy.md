marimo.emit('writecapture61975528\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture61975528", "widget\_prototype": "writecapture\_widget"}).