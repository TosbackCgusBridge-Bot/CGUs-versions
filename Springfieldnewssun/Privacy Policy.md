marimo.emit('writecapture31523295\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture31523295", "widget\_prototype": "writecapture\_widget"}).