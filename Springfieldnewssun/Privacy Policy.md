marimo.emit('writecapture16705924\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture16705924", "widget\_prototype": "writecapture\_widget"}).