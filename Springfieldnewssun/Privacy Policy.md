marimo.emit('writecapture99136375\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture99136375", "widget\_prototype": "writecapture\_widget"}).