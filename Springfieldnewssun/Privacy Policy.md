marimo.emit('writecapture23739433\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture23739433", "widget\_prototype": "writecapture\_widget"}).