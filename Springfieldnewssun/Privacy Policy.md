marimo.emit('writecapture90255811\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture90255811", "widget\_prototype": "writecapture\_widget"}).