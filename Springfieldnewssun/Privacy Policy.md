marimo.emit('writecapture59670288\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture59670288", "widget\_prototype": "writecapture\_widget"}).