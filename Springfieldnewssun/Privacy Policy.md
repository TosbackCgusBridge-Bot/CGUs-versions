marimo.emit('writecapture57757751\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture57757751", "widget\_prototype": "writecapture\_widget"}).