marimo.emit('writecapture11509775\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture11509775", "widget\_prototype": "writecapture\_widget"}).