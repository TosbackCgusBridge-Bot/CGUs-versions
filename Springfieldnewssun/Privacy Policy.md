marimo.emit('writecapture48492216\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture48492216", "widget\_prototype": "writecapture\_widget"}).