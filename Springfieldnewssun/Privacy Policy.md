marimo.emit('writecapture78443735\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture78443735", "widget\_prototype": "writecapture\_widget"}).