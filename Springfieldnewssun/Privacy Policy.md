marimo.emit('writecapture88496583\_ready'). marimo.add\_widget({"wc\_compatibility\_mode": false, "html": "$NEWLINE\\t
...
$NEWLINE ", "id": "writecapture88496583", "widget\_prototype": "writecapture\_widget"}).