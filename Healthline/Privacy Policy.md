...
If a user accepts a Healthline or partner cookie, but would later like to remove it from their computer, they can remove it from the browser. Use of cookies allows Healthline and its partners to monitor traffic flow and patterns of travel within and through the sites, and dynamically personalizes content and advertising.
