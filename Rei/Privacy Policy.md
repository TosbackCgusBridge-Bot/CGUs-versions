...
*   Run
    ...
    *   Men's Pants and Tights
    *   Men's Running Hats
    *   Men's Running Jackets
    *   Men's Running Socks
    *   Men's Running Gloves
    *   All Men's Running Clothes
    *   Running Sale and Clearance Running Shop Triathlon Shop
    ...
    *   All Women's Running Clothes
    
    *   RUNNING SHOES
    *   Men's Cross-Training Shoes
    *   Men's Road-Running Shoes
    *   Men's Trail Running Shoes
    *   Men's Minimalist Running Shoes
    *   Women's Cross-Training Shoes
    *   Women's Road-Running Shoes
    *   Women's Trail Running Shoes
    *   Women's Minimalist Running Shoes
    *   All Running Footwear
...
*   Paddle
    ...
    *   Safety Equipment
    *   Spray Skirts
    *   Car Racks Paddling Sale and Clearance All Paddling
...
*   Deals
    ...
    *   Paddling
    *   Travel
    *   Coupons, rebates &. volume discounts All Sale and Clearance
