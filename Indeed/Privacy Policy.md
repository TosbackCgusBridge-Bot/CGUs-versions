...
For example, in certain cases such processing allows Indeed to match Job Seekers with Employers effectively, to provide Job Seekers with Job Alerts and recommended jobs that the Job Seeker is likely to be more interested in, to send particular Job Seeker applications to an Employer, to display search results, or to perform certain spam and fraud detection activities to protect our users. Such processing is subject to the safeguards detailed in this Privacy Policy to protect the privacy of our users, and you may contact privacy-dept @ indeed.com (remove spaces) to contest any decision generated by said automated processing.
