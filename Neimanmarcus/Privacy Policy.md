...
*   Browser Advisory
    ...
    Download a free copy of Firefox by clicking here. For the latest version of Safari, from the Apple menu, choose Software Update. For the latest Internet Explorer version visit here.
    
    Please be aware that NeimanMarcus.com uses rich media content to improve the user experience. Download and install Adobe Flash to view the website as it was intended.
...
*   Mobile Terms of Use NEIMAN MARCUS MOBILE APPLICATION TERMS OF USE
    ...
    *   Help
    ...
    "Capital One" means Capital One, N.A., the licensor and supplier to Neiman Marcus of the Mobile Wallet Service.  
    ...
    "Mobile Wallet Service" means the Service by which your selected Payment Card and related Payment Credentials are used along with a Transaction Code for your use at a Store point-of-sale. The "Mobile Wallet Service" may also include the ability to use offers or coupons received on your Supported Device and any other Services or features made available by Neiman Marcus from time to time in its sole discretion.  
    ...
    "Payment Card" means a valid credit card, debit card, prepaid card, or other card or payment method that we have decided are eligible to be registered by you to facilitate the processing of transactions using the Mobile Wallet Service.  
    ...
    "Payments Platform" means the third party mobile payment enabler that supports or provides the Mobile Wallet Service to Neiman Marcus for your ultimate use, which initially shall be Paydiant, Inc. ("Paydiant"), which we may change in our sole discretion.  
    ...
    "You", "you" and "your" means a natural person that applies to use, or registers to use, the Services. "Website" or "Neiman Marcus Website" means the website maintained by Neiman Marcus.
    
    Part One:  
    General Terms Governing Use of the NM App
    
    1\. NM App Installation and Registration.  
    You must install any and all NM App updates to continue to use the Services. You may use certain features of the NM App without creating an NM App user account ("Account"). For example, you may browse through the "Shop" Service or locate a store through the "Stores" Service. However, to use certain features and certain Services, you will be required to create and use an Account. This includes, without limitation, when you:
    
    *   Create or add to a Wish List.
    *   Purchase an item on the Website (though you may also check out as a guest or by using select third party services). or
    ...
    **2\. Help/Customer Service.  
    For questions or concerns about your use of the NM App or Services, you may contact us at 888-888-4757 or by email at neimanmarcus@customercare.neimanmarcus.com (or, for Mobile Wallet questions, at 800-720-1613 or mobile\_wallet@neimanmarcus.com). You are solely responsible for contacting your payment card issuer for issues relating to payment, card processing, debiting or crediting.**
    ...
    **We will not be liable to you for compensation, reimbursement, or damages in connection with your use of the NM App or the Services, or any termination or suspension of the NM App, an Account or the Services. If your use of the NM App, an Account or any of the Services is terminated for any reason or no reason, you agree: (a) to continue to be bound by these Terms of Use and remain responsible for any transactions you have processed through use of the Services, (b) to immediately stop using the NM App, (c) that the license provided under these Terms of Use shall end, (d) that we reserve the right (but have no obligation) to delete all of your information and Account data stored on our servers, and (e) that neither Neiman Marcus nor any Provider shall be liable to you or any third party for termination of access to the NM App or the Services or deletion of your information or Account data.**
    ...
    We reserve the right to discontinue the Image Recognition Service at any time.
    ...
    14\. InCircle.  
    If you use the InCircle Service on the NM App, you agree to the InCircle Terms &. Conditions, available at www.incircle.com.
    
    15\. Wish List.  
    You may save items to your Wish List, which list may be stored and accessed in the future or shared with friends and family.
    
    B. Terms Governing Use of the Mobile Wallet Service
    
    16\. Mobile Wallet Service Registration.  
    In order to use the Mobile Wallet Service, you are required to register for an Account. If you choose to register for an Account, you agree to provide us with true, accurate, current and complete information about yourself and update us if there are changes to the information. You also agree that it is your responsibility to update your payment card information, including updating your expiration dates on expired cards. You acknowledge and agree that Neiman Marcus will have no liability associated with or arising from your failure to maintain accurate registration information, including your failure to receive important information and updates about the NM App and the Mobile Wallet Service. If Neiman Marcus has reasonable grounds to suspect that any information you provided to us is untrue, inaccurate or incomplete, Neiman Marcus may suspend or terminate your Account and/or access to the Mobile Wallet Service and refuse any and all current or future use of the Mobile Wallet Service (or any portion thereof) by you.  
      
    As a part of your Account registration, you are required to establish a PIN, which is used to authenticate you when you use the Mobile Wallet Service. The PIN acts as your signature. You are responsible for protecting the confidentiality of your PIN and security of your Supported Device. It is important that you do so since we are not responsible for any losses you incur as a result of unauthorized use of your Account and, depending on the circumstances, your Payment Card issuer may hold you responsible for unauthorized use of your Payment Card. You agree to notify Neiman Marcus immediately of any unauthorized use of your PIN or Account, or any other actual or potential security breach relating to your Account.  
      
    You are responsible for all use of your Account and for ensuring that use of or access to your Account complies fully with these Terms of Use. You acknowledge and agree that any use of the Mobile Wallet Service occurring through your current username and password shall be deemed to be your actions and that Neiman Marcus may rely upon such actions.  
      
    You also authorize Neiman Marcus to confirm that each Payment Card is in good standing with the issuing financial institution, including, but not limited to, by submitting a request for a payment authorization and/or a $0.00 or low dollar credit and/or debit to the Payment Card, in accordance with the relevant Network rules. You authorize Neiman Marcus, directly or through third parties, to make inquiries we consider necessary to validate or authenticate your identity and account information, including, but not limited to, performing an address verification for each Payment Card that you register. Neiman Marcus may require you to provide additional information as a condition of continued use of the Mobile Wallet Service, or to assist in determining whether to permit you to continue to use the Mobile Wallet Service. Any time you add a new Payment Card, you authorize Neiman Marcus to make such inquiries and agree to provide additional information as requested. Neiman Marcus, in its sole and absolute discretion, may refuse to approve or may terminate existing registrations for, or remove Payment Cards from, the Mobile Wallet Service with or without cause or notice, other than any notice required by applicable law.  
      
    If you have questions or need customer service assistance during the registration process, please see the contact information contained in Part One Section 2 above.
    
    17\. How It Works.  
    Our Mobile Wallet Service allows you to make purchases and returns using the Payment Card you select by taking the stored data for that Payment Card and the related Payment Credentials to create a Transaction Code that can be scanned by the Store's point-of-sale system. The Mobile Wallet Service is provided by Neiman Marcus through a third-party Payments Platform. When you use the Mobile Wallet Service to make a purchase, you authorize Neiman Marcus to submit charges to the applicable registered Payment Card issuer and you agree to pay for your purchases in accordance with your agreement with the Payment Card issuer. Your Payment Card information may be stored for future purchases at Stores. No Payment Card or other payment information is stored on your Supported Device through your use of the Mobile Wallet Service, but, certain encrypted data is stored on your Supported Device so that the next time you make a purchase at a Store, you have the option to use this saved Payment Card information to make such purchase. Since this is the information we use to communicate with you and provide the Mobile Wallet Service, it is important to keep your information up to date.
    
    18\. Cardholder Agreements.  
    This Agreement does not amend or otherwise modify the cardholder agreement or any other terms and conditions of your Payment Card issuer. In the event of any inconsistency between these Terms of Use and your cardholder agreement with your Payment Card issuer, these Terms of Use govern as to the relationship between you and Neiman Marcus solely with respect to the Services and your cardholder agreement with your Payment Card issuer governs as to the relationship between you and your Payment Card issuer. You are responsible for ensuring that your use of the Services complies with your cardholder agreement with your Payment Card issuer. You are solely responsible for any interest, fees, charges or expenses related to your use of a Payment Card in connection with the Services and for any taxes or tax reporting obligations in connection with your use of the Services.
    
    19\. Payments Platform.  
    Neither Neiman Marcus nor the Payments Platform is a bank and will not hold or transmit any of your funds nor extend you credit. By your acceptance of these Terms of Use, you authorize the Payments Platform to collect, store, authenticate, and relay information in order to generate the Transaction Codes for the payments you initiate with the Mobile Wallet Service. Transactions consummated through the Mobile Wallet Service are subject to the terms and conditions governing your Payment Card and to any agreements between you and the issuer of your Payment Card.  
    You acknowledge and agree that the Payments Platform is a third party beneficiary of these Terms of Use, and that, upon your acceptance of these Terms of Use, Payments Platform will have the right (and will be deemed to have accepted the right) to enforce these Terms of Use against you as a third party beneficiary thereof.  
    You acknowledge and agree that we may share information with the Payments Platform and that we may switch Payments Platforms in our sole discretion.
    
    20\. Supported Payment Cards. Disputes with Issuers.  
    The Mobile Wallet Service can only be used with supported Payment Cards. The Mobile Wallet Service will only process transactions through Payment Cards that can be authenticated and authorized through our normal processes and procedures. If you have a Neiman Marcus credit card and have provided us with your Neiman Marcus credit card information, your Neiman Marcus credit card will serve as your default Payment Card. If you have registered at least one additional Payment Card, you may have the option to select a default Payment Card.  
    Neiman Marcus does not endorse or sponsor, and is not responsible for, Payment Card issuers or operators of payment networks that you may use in connection with the Mobile Wallet Service. If you have a dispute with a Payment Card issuer or operator of a payment network about a transaction made with the Mobile Wallet Service, you are solely responsible for settling the dispute directly with the Payment Card issuer or operator of a payment network.  
    You may not use a Health Savings Account card with the Mobile Wallet Service or any gift card or other prepaid cards. Your Mobile Wallet is not a bank account. Neiman Marcus is not a bank and does not offer banking or money service business services as those terms are defined by the U.S. Department of Treasury.
    
    21\. Store Locations.  
    The Mobile Wallet Service can be used to make purchases at Neiman Marcus, Bergdorf Goodman, CUSP and Last Call Stores. The Mobile Wallet Service is not available at our restaurants at this time.
    
    22\. Right to Withdraw Service.  
    Neiman Marcus reserves the right to withdraw the Mobile Wallet Service from the NM App at any time. You acknowledge that Neiman Marcus has no express or implied obligation to provide, or continue to provide the Mobile Wallet Service, or any part thereof, now or in the future. You further acknowledge that Neiman Marcus may at any time, upon notice as required by applicable law, institute charges or fees for your use of the Mobile Wallet Service or the NM App.
    
    23\. Account History.  
    The transaction will appear in your Payment Card account activity maintained by the issuer of your Payment Card. Except as otherwise required by law or by the terms of another agreement between you and Neiman Marcus, you are solely responsible for (a) compiling and retaining permanent records of all transactions and other data associated with your use of the Mobile Wallet Service, and (b) reconciling all transactional information that is associated with the Mobile Wallet Service. If you believe that there is an error or unauthorized transaction activity is associated with the Mobile Wallet Service, you agree to contact the Payments Platform and the Payment Card issuer(s) associated with such suspected error or unauthorized transaction activity immediately to notify such parties of the error or unauthorized transaction
    ...
    You may only use the Mobile Wallet Service to generate Transaction Codes for legitimate, bona fide purchases of goods or services offered by or through Neiman Marcus. The Mobile Wallet Service may not be used to engage in a transaction or otherwise transfer money that is unrelated to the purchase of goods or services offered by or through Neiman Marcus. The NM App and its Services may not be used in connection with the sale or exchange of any illegal goods or services or any other illegal transaction.
    ...
    Nothing in these Terms of Use will be construed as creating a joint venture, partnership, employment or agency relationship between you and Neiman Marcus, and you do not have any authority to create any obligation or make any representation on Neiman Marcus' behalf.
    ...
    34\. Waiver.  
    Our failure or delay to exercise or enforce any provision or right contained in these Terms of Use shall not be deemed a waiver of such provision or right.
    
    35\. Governing Law.  
    By using the NM App or the Services, you agree that the laws of the State of Texas, without regard to principles of conflict of laws, will govern these Terms of Use and any dispute of any sort that might arise between you and us.
    
    36\. Disputes.  
    Any dispute relating in any way to your use of the Services or to products purchased using the Services shall be submitted to confidential arbitration in Dallas, Texas. However, if you have in any manner violated or threatened to violate our intellectual property rights, we may seek injunctive or other appropriate relief in any state or federal court in the State of Texas. You consent to exclusive jurisdiction and venue in such courts. Any arbitration under these Terms of Use shall be conducted under the prevailing rules of the American Arbitration Association. The arbitrator's award shall be binding and may be entered as a judgment in any court of competent jurisdiction. To the fullest extent permitted by applicable law, no arbitration with respect to the Services or to products purchased using the Services shall be joined to an arbitration involving any other party, whether through class arbitration proceedings or otherwise.
    
    37\. Limitation on Time to Commence Legal Proceedings.  
    Unless otherwise required by law, any action or proceeding by you to enforce an obligation, duty, or right arising under these Terms of Use or by law must commence within one year after the cause of action accrues.
    
    38\. Right to Amend or Modify the Terms of Use.  
    We have the right, at our sole discretion, to change or add to these Terms of Use at any time, and to change, delete, discontinue, or impose conditions on any feature or aspect of the NM App or Services with notice that we in our sole discretion deem to be reasonable in the circumstances. Such modifications will become effective upon our posting them in the NM App and/or on our Website. You may request the current Terms of Use by email at neimanmarcus@customercare.neimanmarcus.com or mobile\_wallet@neimanmarcus.com. We may also provide notice to you when you access the NM App or the Services. Any use of the NM App or the Services after publication of any such changes shall constitute your acceptance of and agreement to the Terms of Use as modified.
    
    39\. Assignment.  
    These Terms of Use, and any rights and licenses granted hereunder, may not be transferred or assigned by you, but may be assigned by Neiman Marcus without restriction.
    
    40\. Notice.  
    Notice to Neiman Marcus must be sent by postal mail to: PO Box 729080, Dallas, TX 75372 or by email to neimanmarcus@customercare.neimanmarcus.com or, for Mobile Wallet Service notices, by postal mail to the address above or by email to mobile\_wallet@neimanmarcus.com. Notice to you may be made by SMS text message to your mobile phone number associated with your Account, by posting a notice through the NM App or by email to your email address associated with your Account. Please keep your mobile phone number and email address in your Account information up to date.
    
    41\. Links to Other Websites. Social Media.  
    ...
    For questions or concerns about your use of the NM App or Services, you may contact us at 888-888-4757 or by email at neimanmarcus@customercare.neimanmarcus.com (or, for Mobile Wallet questions, at 800-720-1613 or mobile\_wallet@neimanmarcus.com).
