...
*   Scribd does not share your personally identifiable information with other organizations for their marketing or promotional uses without your prior express consent, except that if you have provided us with an email address, Scribd may provide a hashed version of it to its advertising partner, RapLeaf, to enable better targeted advertising where RapLeaf already possesses your email address.  If RapLeaf does not already have your email address in its records, it cannot use the hashed version that we provide.  For more information on RapLeaf’s privacy practices, and to opt out, please visit https://www.rapleaf.com/privacy.
...
You may, of course, decline to share your personally-identifiable information with Scribd, in which case Scribd will not be able to provide to you some of the features and functionality found on the Scribd Platform. You may update, correct, or delete your user information and preferences at any time here.

You may also choose to opt-out of receiving interest-based advertising from many of our advertising partners and others by visiting http://www.aboutads.info/choices/ or http://www.networkadvertising.org/managing/opt\_out.asp
...
Scribd adheres to the Digital Advertising Alliance’s _Self-Regulatory Principles for Online Behavioral Advertising_, available at www.aboutads.info.  Our advertising partners, such as RapLeaf and BlueKai, may use technology to provide the advertisements that appear on the Scribd Platform and to use data collected through the Scribd Platform, as described above and in this section, to better target ads shown on Scribd and other websites. For a list of many of the advertisers that may work with Scribd please visit www.aboutads.info/participating.
...
PLEASE CONTACT SCRIBD WITH ANY QUESTIONS OR COMMENTS ABOUT THIS PRIVACY NOTICE, YOUR PERSONAL INFORMATION, AND OUR THIRD-PARTY DISCLOSURE PRACTICES OR YOUR CONSENT CHOICES AT: SCRIBD.COM, 539 BRYANT ST., SUITE 200, SAN FRANCISCO, CA 94107, OR BY EMAIL: PRIVACY@SCRIBD.COM. WE WILL RESPOND TO YOUR INQUIRY WITHIN 30 DAYS OF ITS RECEIPT.
