...
After your stay at any property booked through us, you'll be invited to submit a guest review, which may ask for information about the property, the surrounding areas, and the destination. If you don’t want your name to show with your review, you can use your screen name (which you can choose in your user account) or it can be displayed anonymously. By completing a guest review, you're agreeing that it can be displayed (as further described in our Terms and Conditions) on, for example, the relevant property information page on our websites, in our mobile apps, in our social media accounts and in social apps, or on the website of the relevant property or on our business partner’s website, to inform other travelers about the quality and services of the property you stayed in.
