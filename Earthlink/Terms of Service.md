...
EarthLink reserves the right to verify the accuracy of the information you submit in connection with your subscription and your account and you consent to such verification. EarthLink also reserves the right to validate the payment method information you provide at subscription for the Cable Internet Service and/or EarthLink Value Added Services, if applicable, and account updates including attempting up to a $1.00 authorization to your credit card or debit card which is not actually billed. To understand how EarthLink handles and protects your personal information, please see the **EarthLink Privacy Policy** .
...
**7\. PROVISIONING, BILLING AND PAYMENT**

The Cable Provider will bill you for your usage of the Cable Internet Service. Your bill from the Cable Provider will show charges for the Cable Internet Service, and any applicable taxes, surcharges, and fees set by the government. Changing your plan's Cable Internet Service's speed, if available, may affect your monthly fee. The billing plans may vary by geographic location and Cable Provider.
...
If you elected to purchase any EarthLink value added services ("EarthLink Value Added Services"), such as Attack Shield, charges for such EarthLink Value Added Services and any billing fees, taxes, surcharges and fees required by a government entity, if applicable, will be billed to your method of payment on file with EarthLink. EarthLink is not responsible for any charges or expenses (e.g., for overdrawn accounts, exceeding credit card limits, etc.) resulting from charges for the EarthLink Value Added Services billed by EarthLink. The monthly fees for the EarthLink Value Added Services will be due in advance of the month incurred. All payments must be made in US dollars. You must provide accurate billing information including legal name, address, telephone number, and credit or debit card and report all changes to this information promptly to EarthLink.

Charges for the EarthLink Value Added Services may be billed on or after your billing cycle date to your method of payment on file each month for your EarthLink Value Added Services including any additional charges incurred (e.g. taxes and fees). EarthLink is not responsible for any fees resulting from charges billed by EarthLink including, but not limited to, overdrawn accounts or exceeding credit card limits.

EarthLink will email an e-invoice for your Value Added Services to your primary EarthLink email address selected by or assigned to you during the subscription process ("Contact Email Address") each month or if you designated a different billing email address, EarthLink will email the e-invoice to such billing email address each month. In the event that you request that EarthLink to mail you a paper invoice each month for your EarthLink Value Added Services rather than emailing you an e-invoice, EarthLink will charge an account fee for each paper invoice.

If you provided EarthLink with a valid credit or debit card to pay for your EarthLink Value Added Services, you agree to maintain valid and current credit or debit card information with EarthLink at all times. You acknowledge and agree that you authorize EarthLink and that EarthLink does not need to obtain any additional authorization from you for any recurring payments or automatic billing options. In addition, if your credit or debit card company provides updated credit or debit card information to EarthLink, you acknowledge that EarthLink does not need to obtain authorization from you for EarthLink to use such information to update your credit or debit card. If payment by check has been accepted by EarthLink for your EarthLink Value Added Services, then payments by check must be received by EarthLink by the due date listed in your monthly invoice. EarthLink will charge (i) a check processing fee for each check and (ii) a paper invoice fee. When you pay your fees by check, you also authorize EarthLink to electronically process your payment. If your check is processed electronically, your checking account may be debited on the same day that EarthLink receives your check and neither your check nor a copy of your check will be included with your checking account statement. EarthLink will charge a fee for returned checks or returned bank drafts from your financial institution.

EarthLink reserves the right to change (i) fees and institute new fees associated with your EarthLink Value Added Services upon email notice at least 30 days prior to the effective date of such new fee to your Contact Email Address and (ii) fees associated with your account upon email notice at least 30 days prior to the effective date of such new fee to your Contact Email Address or your billing email address if different from your Contact Email address.
...
EarthLink reserves (i) the right to change the monthly fees associated with the EarthLink Value Added Services upon email notice at least 30 days prior to the effective date of such new monthly fee to your Contact Email Address and (ii) the right to change the fees associated with your account upon email notice at least 30 days prior to the effective date of such new fee to your Contact Email Address or your billing email address if different from your Contact Email address.
...
EarthLink only accepts cancellation by phone, fax or U.S. Mail. EarthLink does NOT accept cancellations by email. EarthLink will issue a confirmation number to you by email as your proof of cancellation.
...
EarthLink has no obligation to monitor the Cable Internet Service, but may do so with the assistance of your Cable Provider to: (i) comply with laws, regulations, or governmental or legal requests. (ii) protect the overall integrity of its network including preventing the distribution of viruses or other malicious code. (iii) operate the technical aspects of the Cable Internet Service in a proper, effective, and reasonable manner. (iv) protect itself, its employees, or others as described in the EarthLink Privacy Policy . and (v) to enforce or prevent breaches of this Agreement or other EarthLink agreements or policies, including the EarthLink Acceptable Use Policy .
...
> The Cable Internet Service is provided by EarthLink, Inc., 1375 Peachtree Street, Atlanta, Georgia 30309, telephone: 800-955-0186 , in conjunction with your Cable Provider.
> 
> Charges may vary depending on the type of Cable Internet Service.
> 
> The Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs may be contacted in writing at 1625 N. Market Blvd., Suite S-202, Sacramento, CA 95834 or by telephone at 1 -800-952-5210.
...
The following endnotes summarize the material revisions made in this August 1, 2013 version of the Agreement compared to the previous version of the Agreement dated July 7, 2011.

1 The first sentence in Section 2 was revised to clarify that the effective date of this Agreement is the date you subscribe to the Service.

2 The second paragraph in Section 13 was added to clarify that you are agreeing that EarthLink may call or text you at the phone number provided with your subscription or use of the Service.