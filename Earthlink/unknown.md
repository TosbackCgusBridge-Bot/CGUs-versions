...
Because of the complex nature of Internet service, availability, and the underlying infrastructure, it may not be possible to provide the EarthLink Residential DSL Service or the PeoplePC Residential DSL Service (collectively referred to as "DSL Service") to everyone. In its sole discretion, EarthLink may cancel the installation process and refund any money that you have paid. EarthLink will notify you of its intent to cancel as soon as reasonably possible. It may take up to 90 days to determine if EarthLink is able to provide the DSL Service.

The EarthLink Dial-Up Service and the PeoplePC Dial-Up Service (collectively referred to as "Dial-Up Service") accounts also include a dial-up connection to the Internet for up to 20 hours per monthly billing cycle. In calculating the 20 hours of usage, the usage of each Device logged into your EarthLink dial-up account to access the Internet is counted. For example, if you have two Devices logged in from 10:00 a.m. to 11:00 a.m., your total usage for that time period will be 2 hours of usage. If your dial-up connection usage exceeds 20 hours per month, you will be charged an additional $1.00 per hour (up to a maximum of $21.95 per month), pro-rated to the minute, through the end of the monthly billing cycle.

DSL Service accounts also allow up to 20 hours per monthly billing cycle of dial-up modem access to the Internet. In calculating the 20 hours of usage, the usage of each Device accessing the Internet via a dial up modem is counted. For example, if you have two Devices logged in from 10:00 a.m. to 11:00 a.m., your total usage for that time period will be 2 hours of usage. If your dial-up connection usage exceeds 20 hours per month, you will be charged an additional $1.00 per hour (up to a maximum of $21.95 per month), pro-rated to the minute, through the end of the monthly billing cycle.
...
**6\. SPECIFIC TERMS FOR THE EARTHLINK ACCESS SOFTWARE, THE DIAL-UP MODEM AND THE DSL MODEM**
...
In addition to the EarthLink Access Software, the DSL Service and the Dial-Up Service require a modem to access the Internet. EarthLink recommends use of the EarthLink DSL Modem to ensure proper ongoing support for the DSL Service. EarthLink will the EarthLink DSL Modem in the Self-Installation Kit. The EarthLink DSL Modem for new DSL Service subscribers is free and you just have to pay the shipping and handling fees. New DSL Service subscribers have the option to decline EarthLink's offer of a free EarthLink DSL Modem. However, EarthLink does not guarantee technical support of other modems. The EarthLink DSL Modem has a 365 days' warranty from the original shipment date of the EarthLink DSL Modem against defects in material and workmanship under ordinary consumer use from the shipment date as stated on its packing slip ("EarthLink DSL Modem Warranty Period"). In the event that you have a problem with your DSL Service within the EarthLink DSL Modem Warranty Period and EarthLink Technical Support confirms that your original EarthLink DSL Modem is defective, EarthLink will ship you a new or refurbished EarthLink DSL Modem at no charge. In the event that you have a problem with your DSL Service after the EarthLink DSL Modem Warranty Period and EarthLink Technical Support confirms that your EarthLink DSL Modem is defective, EarthLink will mail you a refurbished EarthLink DSL Modem and you will only have to pay the shipping and handling fees.

If your Device does not have a modem to access a dial-up connection, you may order the EarthLink Dial-Up Modem to access the Dial-Up Service for a one-time charge plus shipping and handling fees. EarthLink warrants the EarthLink Dial-Up Modem against defects in material and workmanship under ordinary consumer use for a warranty period of 365 days from the original shipment date of the Dial-Up Modem ("EarthLink Dial-Up Modem Warranty Period"). The original shipment date is stated on the EarthLink packing slip. This warranty applies to the original subscriber and is not transferable.

The warranty for the EarthLink Dial-Up Modem for the EarthLink Dial-Up Warranty Period includes the following:

> 1.  You must contact EarthLink Technical Support via telephone or chat support about your defective Dial-Up Modem.
> 2.  If EarthLink Technical Support confirms that your EarthLink Dial-Up Modem is defective, at its option, will ship to you a new or refurbished EarthLink Dial-Up Modem in a package with a prepaid return shipping label you to use to ship your defective EarthLink Dial-Up Modem back to Dial-Up. In order for the return to be processed correctly, you will need to use the EarthLink Dial-Up provided prepaid shipping label.
> 3.  If you mail your defective EarthLink Dial-Up Modem to EarthLink within 30 days from the shipment date of the new or refurbished EarthLink Dial-Up Modem as stated on its packing slip, Dial-Up will not charge you for the new or refurbished EarthLink Dial-Up Modem. If you mail the defective EarthLink Dial-Up Modem to EarthLink after such 30 day period or if you do not mail the defective EarthLink Dial-Up Modem back to EarthLink, EarthLink will charge a non-return hardware fee that is equal to the charge for a refurbished EarthLink Dial-Up Modem .
> 4.  The new or refurbished EarthLink Dial-Up Modem will have a 365 day warranty starting on the shipping date listed on its packing slip.

This warranty does not cover defects resulting from use of the EarthLink Dial-Up Modem contrary to the instructions or repair or modification by you or any party other than EarthLink. This warranty gives you specific legal rights, and you may also have other rights that vary from state to state.

In the event that the EarthLink Dial-Up Modem fails after the EarthLink Dial-Up Modem Warranty Period, you can either purchase a new EarthLink Dial-Up Modem that will include a 365 days warranty or purchase a refurbished EarthLink Dial-Up Modem at a lower price than the new EarthLink Dial-Up Modem that will not include any warranty.

If you have any problems with installation of either the EarthLink DSL Modem or the EarthLink Dial-Up Modem (collectively, "EarthLink Modem"), you can contact EarthLink Technical Support for assistance. EarthLink may suggest an outside vendor to help install the EarthLink Modem. You will be responsible for all costs and scheduling associated with the installation of the EarthLink Modem by a third party. You are also responsible for all inside wiring repair necessary to install the EarthLink Modem.
...
If your billing plan is based on a monthly subscription fee, you will be billed a flat monthly fee. If your billing plan is based on usage, you will be billed each month based on usage. In addition, your bill will include (i) taxes, surcharges, and fees required by any applicable government entity and (ii) shipping and handling fees.
...
The following endnotes summarize the material revisions made in this August 1, 2013 version of this Agreement compared to the previous version of this Agreement dated January 3, 2012.
...
2 The second paragraph in Section 15 was added to clarify that you are agreeing that EarthLink may call or text you at the phone number provided with your subscription or use of the Service.

3 The third paragraph in Section 16 was added to state that EarthLink does not provide technical support for computer software configurations and browser setups for problems connecting to the Internet through smart phones.