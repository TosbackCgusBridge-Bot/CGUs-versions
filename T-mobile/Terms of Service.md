...
Did you activate (or renew) service prior to February \_\_, 2016? If yes, please click the date for the applicable version of the Terms and Conditions: January 25, 2016 | November 14, 2015 | June12, 2015 | March 18, 2015 |November 10, 2014 |March 27, 2014 |October 20, 2013 |December 30, 2011 |July 24, 2011 |July 18, 2010 |June 28, 2008 | December 2004
...
*   We utilize streaming video optimization technology throughout our network, as a customer-controlled feature on qualifying plans, which minimizes high speed data consumption, while also improving the service experience for all customers. For more information on video optimization, click here.
...
We deploy streaming video optimization technology throughout our network as a customer-controlled feature on qualifying plans, which also ensures that available network capacity can be utilized to provide a good service experience for the maximum number of customers. This technology is intended to manage data usage on the network, reduce the risk of streaming video stalling and buffering on mobile devices, and reduce the amount of high-speed data consumed for streaming video. Streaming video optimization improves streaming video reliability and, by reducing the amount of data used for streaming video on the network, makes room for other users to enjoy higher speeds. Video optimization occurs only to data streams that are identified by our packet-core network as video. The streaming video optimization process is agnostic as to the streaming video content itself and to the service that provides it. While many changes to streaming video files are likely to be indiscernible, the optimization process may impact the appearance of the streaming video as displayed on a user’s device. Plans that feature this technology allow customers to choose to enable (and disable) video streaming optimization when connected to the cellular network. When enabled, video is typically delivered at DVD quality (480p or better).
